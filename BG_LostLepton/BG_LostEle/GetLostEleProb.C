...
void GetLostEleProb(TString iFname){
  ...
  //  f[0] = new TFile("CS_WGWJets_LostEle_clsr.root");
  //  gStyle->SetOptStat("nemri");
  sprintf(name,"LstEle_%s",f[0]->GetName());
  ...
  name1.push_back("dPhi_METBestPhoton_Ele0");   name2.push_back("dPhi_METBestPhoton_Ele1");  rebin.push_back(5);
  //  name1.push_back("GenEle_MT2Activity_Ele0");   name2.push_back("GenEle_MT2Activity_Ele1"); rebin.push_back(10);
  //  name1.push_back("jet1Pt_Ele0");   name2.push_back("jet1Pt_Ele1");  rebin.push_back(10);
  //  name1.push_back("jet2Pt_Ele0");   name2.push_back("jet2Pt_Ele1");  rebin.push_back(10);
  ...
  for(int i=1;i<=4;i++){
    //    name1_2d.push_back("STMET_Ele0_R"+to_string(i));   name2_2d.push_back("STMET_Ele1_R"+to_string(i));newName.push_back(to_string(i));
  }
