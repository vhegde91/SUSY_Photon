...
void splitRunList(string infile,int nfPerJob){
  TString tstr1 = infile;
  //------------ needed for condor files --------------
  string exeCondor  = "worker2.sh";
  string exeAna     = "lostEle";
  string datasetAna = "";
  string rootFilesToTransfer = "SF_Files.tar,lostEle";
                               //give the name of the files seperated by comma(,). Ex:("a.root,b.root")
  //---------------------------------------------------
  if(tstr1.Contains("WGJets_MonoPhoton")) datasetAna = "WG";
  if(tstr1.Contains("TTGJets_")) datasetAna = "TTG";
  if(tstr1.Contains("TTJets_HT-")) datasetAna = "TTJets";
  if(tstr1.Contains("TTJets_") && tstr1.Contains("Lept")) datasetAna = "TTJets_Lept";
  if(tstr1.Contains("TGJets_TuneCUET")) datasetAna = "TG";
  if(tstr1.Contains("ZGTo2LG")) datasetAna = "ZG";
  if(tstr1.Contains("DYJetsToLL")) datasetAna = "ZJets";
  if(tstr1.Contains("WJetsToLNu_HT")) datasetAna = "WJets";
