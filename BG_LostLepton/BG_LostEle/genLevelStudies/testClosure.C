...
void testClosure(TString iFname){
  ...
  vector<int> rebin;
  name1.push_back("genEle1EtaP_PtG100");      name2.push_back("genEle1EtaM_PtG100");      rebin.push_back(20);
  name1.push_back("genMu1EtaP_PtG100");       name2.push_back("genMu1EtaM_PtG100");      rebin.push_back(20);
  name1.push_back("genTau1EtaP_PtG100");      name2.push_back("genTau1EtaM_PtG100");      rebin.push_back(20);
  name1.push_back("genLeadPhoEtaP");          name2.push_back("genLeadPhoEtaM");      rebin.push_back(20);
  name1.push_back("genLeadPhoEtaP_PtG100");   name2.push_back("genLeadPhoEtaM_PtG100");      rebin.push_back(20);
  name1.push_back("genMu1Pt_PtG100");        name2.push_back("genEle1Pt_PtG100");      rebin.push_back(5);
  name1.push_back("genMu1Pt");        name2.push_back("genEle1Pt");      rebin.push_back(5);
  //  name1.push_back("genEle1Pt");        name2.push_back("genTau1Pt");      rebin.push_back(5);
  //  name1.push_back("genTau1Pt");        name2.push_back("genMu1Pt");      rebin.push_back(5);
  name1.push_back("nGenMu");        name2.push_back("nGenEle");      rebin.push_back(1);
  name1.push_back("nGenTau");        name2.push_back("nGenEle");      rebin.push_back(1);
  ...
  for(int i=0;i<name1.size();i++){
	...
	// h_histE->SetFillColor(h_histE->GetLineColor());
 	h_histE->Draw("e1sames");
	//	h_histE->Draw("L same");

	legend[i]=new TLegend(0.72, 0.87,  0.87, 0.67);
	name=name1[i];
	legend[i]->AddEntry(h_histG,h_histG->GetName(),"lp");
	name=name2[i];
	legend[i]->AddEntry(h_histE,h_histE->GetName(),"lp");
	legend[i]->Draw();
    ...
    //    TString name = "#frac{"+h_histG->GetName()+"}{"+h_histE->GetName()+"}";
    //    TString name_1 = h_histG->GetName(),name_2=h_histE->GetName();
    TString name="ratio";//"#frac{"+name_1+"}{"+name_2+"}";
    h_numr->GetYaxis()->SetTitle(name);
    h_numr->SetMaximum(1.25);
    h_numr->SetMinimum(0.78);
