...
class LostEle : public NtupleVariables{
 ...
 public:
  ...
  TH1D *h_genDRLepPho_Ele0;
  TH1D *h_genDRqrkPho_Ele0;
  ...
  TH1D *h_dR_ElePho;
  TH1D *h_genDRLepPho_Ele1;
  TH1D *h_genDRqrkPho_Ele1;
  ...
  TH1D *h_tot_Ele1;
  TH1D *h_ScaleWts_Ele1;
  TH1D *h_PDFwts_Ele1;

  TH2D *h2_SBinsv4VsnJ_Ele0,*h2_SBinsv4VsnJ_Ele1;
...
void LostEle::BookHistogram(const char *outFileName) {
  ...
  h_genDRLepPho_Ele0=new TH1D("genDRLepPho_Ele0","#DeltaR(gen e,gen photon) for 0 Ele events",100,0,10);
  h_genDRqrkPho_Ele0=new TH1D("genDRqrkPho_Ele0","#DeltaR(gen q,gen photon) for 0 Ele events",100,0,10);
  ...
  h_tot_Ele0=new TH1D("tot_Ele0","number of events for 0 Ele events",2,0.5,1.5);
  h_ScaleWts_Ele0=new TH1D("MC_ScaleWts_Ele0","Total events weighted by Scale Weights for MC for 0 Ele events",16,-0.5,15.5);
  h_PDFwts_Ele0=new TH1D("MC_PDFwts_Ele0","Total events weighted by PDF weights for 0 Ele events",151,-0.5,150.5);
  //****************************************************
  ...
  h_genDRLepPho_Ele1=new TH1D("genDRLepPho_Ele1","#DeltaR(gen e,gen photon) for 1 Ele events",100,0,10);
  h_genDRqrkPho_Ele1=new TH1D("genDRqrkPho_Ele1","#DeltaR(gen q,gen photon) for 1 Ele events",100,0,10);
  ...
  h_tot_Ele1=new TH1D("tot_Ele1","number of events for 1 Ele events",2,0.5,1.5);
  h_temp=new TH1D("temp","temp",200,0,2000);
  h_ScaleWts_Ele1=new TH1D("MC_ScaleWts_Ele1","Total events weighted by Scale Weights for MC for 1 Ele events",16,-0.5,15.5);
  h_PDFwts_Ele1=new TH1D("MC_PDFwts_Ele1","Total events weighted by PDF weights for 1 Ele events",151,-0.5,150.5);
  //---------------- search bins -----------------------
  h2_SBinsv4VsnJ_Ele0 = new TH2D("SBinsv4VsnJ_Ele0","x:search bins: [ NJ:2-4, NJ:5or6, NJ>=7] x [0b, >=1b] , y: nHadJets for 0 Ele events",43,0.5,43.5,nHadJLow0b.size()-1,&(nHadJLow0b[0]));
  h2_SBinsv4VsnJ_Ele1 = new TH2D("SBinsv4VsnJ_Ele1","x:search bins: [ NJ:2-4, NJ:5or6, NJ>=7] x [0b, >=1b] , y: nHadJets for 1 Ele events",43,0.5,43.5,nHadJLow0b.size()-1,&(nHadJLow0b[0]));
