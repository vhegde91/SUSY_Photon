...
void searchBinsClosure(TString iFname){
  ...
  TH1D *h_CR=new TH1D("searchBins_Ele0","searchBins 0 Ele:ST(500,Inf)-[2,4][5,6],[7,inf)",21,0.5,21.5);
  TH1D *h_SR=new TH1D("searchBins_Ele1","searchBins 1 Ele:ST(500,Inf)-[2,4][5,6],[7,inf)",21,0.5,21.5);
