...
void METclosureTest(TString iFname){
  ...
  name1.push_back("MET0b0Mu");    name2.push_back("MET0b1Mu");  rebin.push_back(1);
  name1.push_back("MET1b1Mu");    name2.push_back("MET1b1Mu");  rebin.push_back(1);
  
  vector<double> METBinLowEdgeV7_njLow={0,100,200,270,350,450,750,900};
  vector<double> METBinLowEdgeV7={0,100,200,270,350,450,750};
  
  TH1D *h_0b0Mu = new TH1D("MET0b0Mu","0b0Mu",METBinLowEdgeV7_njLow.size()-1,&(METBinLowEdgeV7_njLow[0]));
  TH1D *h_0b1Mu = new TH1D("MET0b1Mu","0b1Mu",METBinLowEdgeV7_njLow.size()-1,&(METBinLowEdgeV7_njLow[0]));
  TH1D *h_1b0Mu = new TH1D("MET1b0Mu","1b0Mu",METBinLowEdgeV7.size()-1,&(METBinLowEdgeV7[0]));
  TH1D *h_1b1Mu = new TH1D("MET1b1Mu","1b1Mu",METBinLowEdgeV7.size()-1,&(METBinLowEdgeV7[0]));
  TH1D *h_0mu = (TH1D*)f[0]->Get("AllSBins_v7_Mu0");
  TH1D *h_1mu = (TH1D*)f[0]->Get("AllSBins_v7_Mu1");
  double met=-100;
  h_0b0Mu->SetBinContent(2, h_0mu->GetBinContent(1)+h_0mu->GetBinContent(7)+h_0mu->GetBinContent(12));
  h_0b0Mu->SetBinContent(3, h_0mu->GetBinContent(2)+h_0mu->GetBinContent(8)+h_0mu->GetBinContent(13));
  h_0b0Mu->SetBinContent(4, h_0mu->GetBinContent(3)+h_0mu->GetBinContent(9)+h_0mu->GetBinContent(14));
  h_0b0Mu->SetBinContent(5, h_0mu->GetBinContent(4)+h_0mu->GetBinContent(10)+h_0mu->GetBinContent(15));
  h_0b0Mu->SetBinContent(6, h_0mu->GetBinContent(5)+h_0mu->GetBinContent(11)+h_0mu->GetBinContent(16));
  h_0b0Mu->SetBinContent(7, h_0mu->GetBinContent(6));
  h_0b0Mu->SetBinContent(2, h_0mu->GetBinContent(1)+h_0mu->GetBinContent(7)+h_0mu->GetBinContent(12));
  h_0b0Mu->SetBinContent(3, h_0mu->GetBinContent(2)+h_0mu->GetBinContent(8)+h_0mu->GetBinContent(13));
  h_0b0Mu->SetBinContent(4, h_0mu->GetBinContent(3)+h_0mu->GetBinContent(9)+h_0mu->GetBinContent(14));
  h_0b0Mu->SetBinContent(5, h_0mu->GetBinContent(4)+h_0mu->GetBinContent(10)+h_0mu->GetBinContent(15));
  ...
  for(int i=0;i<h_0mu->GetNbinsX();i++){
    if     (i==1 || i==7  || i==12 || i==17 || i==22 || i==27)      met = 150.;
    else if(i==2 || i==8  || i==13 || i==18 || i==23 || i==28)      met = 235.;
    else if(i==3 || i==9  || i==14 || i==19 || i==24 || i==29)      met = 310.;
    else if(i==4 || i==10 || i==15 || i==20 || i==25 || i==30)      met = 400.;
    else if(i==5 || i==11 || i==16 || i==21 || i==26 || i==31)      met = 600.;
    else if(i==6)                                                   met = 825.;
