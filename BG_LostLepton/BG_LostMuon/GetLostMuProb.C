...
void GetLostMuProb(TString iFname){
  ...
  gStyle->SetOptStat(0);
  // f[0] = new TFile("CS_WGWJets_LostMu.root");
  //f[0] = new TFile("CS_WGWJets_LostMu_clsr_3d.root");
  //  f[0] = new TFile("CS_WGWJets_LostMu_clsr_dphi2HadJ.root");
  //  f[0] = new TFile("CS_WGWJets_LostMu_clsr_dPhi1dPhi2.root");
  //f[0] = new TFile("CS_WGWJets_LostMu_clsr_STMET.root");
  //f[0] = new TFile("CS_WGWJets_LostMu_clsr_STMET.root");
  //f[0] = new TFile("CS_TTW_LostMu_clsr_METHadJ.root");
  //  f[0] = new TFile("CS_WGWJets_LostMu_clsr_dphi1MET.root");
  //f[0] = new TFile("CS_TTW_LostMu_v3.root");
  f[0] = new TFile(iFname);
    //  f[0] = new TFile("CS_TTW_LostMu_clsr_STMET.root");
  //  f[0] = new TFile("CS_WGWJets_LostMu_clsr.root");
  //  gStyle->SetOptStat("nemri");
  sprintf(name,"LstMu_%s",f[0]->GetName());
