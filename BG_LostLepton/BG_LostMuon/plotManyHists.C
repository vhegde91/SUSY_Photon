...
vector<int> rebin;
TString xAxisName="#DeltaR(q,#gamma)";
TString yAxisName="";
...
void plotManyHists(){
  ...
  fNames.push_back("CS_TTJets_LostMuHadTau_v2.root"); 
  histName.push_back("madMinPhotonDeltaR_Mu1");
  legName.push_back("t#bar{t}");
  rebin.push_back(1);
  //-------------------------------------
  fNames.push_back("CS_TTG_LostMuHadTau_v2.root");
  histName.push_back("madMinPhotonDeltaR_Mu1");
  legName.push_back("t#bar{t}#gamma");
  rebin.push_back(1);
  //-------------------------------------
  //-------------------------------------
  // fNames.push_back("");
