...
void compDataVsMC(TString iFname){
  ...
  f[1] = new TFile("CS_TTW_LostMuHadTau_v2.root");
  ...
  name1.push_back("BestPhotonPt_Mu1");   rebin.push_back(1);  //name2.push_back("BestPhotonPt_Mu1");      
  //  name1.push_back("BestPhotonEta_Mu1"); rebin.push_back(10);  //name2.push_back("BestPhotonEta_Mu1");  
  name1.push_back("METvarBin_Mu1");  rebin.push_back(1); //name2.push_back("METvarBin_Mu1");  
  name1.push_back("invMassPhoMu");  rebin.push_back(1); //name2.push_back("METvarBin_Mu1");  
  // name1.push_back("dPhi_METjet1_Pho_Mu1"); rebin.push_back(1);  //name2.push_back("dPhi_METjet1_Pho_Mu1");  
  // name1.push_back("dPhi_METjet2_Pho_Mu1"); rebin.push_back(1);  //name2.push_back("dPhi_METjet2_Pho_Mu1");  
  // name1.push_back("dPhi_METBestPhoton_Mu1"); rebin.push_back(1);   //name2.push_back("dPhi_METBestPhoton_Mu1");  
  // name1.push_back("dPhi_Muon_Photon"); rebin.push_back(2);
  // name1.push_back("MET_Mu1_R1");         name2.push_back("MET_Mu1_R1");rebin.push_back(1);
  // name1.push_back("MET_Mu1_R2");         name2.push_back("MET_Mu1_R2");rebin.push_back(1);
  // name1.push_back("MET_Mu1_R3");         name2.push_back("MET_Mu1_R3");rebin.push_back(1);
