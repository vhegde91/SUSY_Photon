...
class LostMuon : public NtupleVariables{
 ...
 public:
  ...
  vector<double> STInclLowEdge={0,500,5000};
  ...
  vector<double> ST_NJ5or6LowEdge={0,500,700,5000};
  vector<double> ST_NJ7toInfLowEdge={0,500,800,5000};
  ...
  TH2D *h2_STMET_2to3HadJ_Mu0; TH2D *h2_STMET_2to3HadJ_Mu0_fb;
  TH2D *h2_STMET_min4HadJ_Mu0;
  TH2D *h2_STMET_2to3HadJ_Mu0_R[6];
  TH2D *h2_STHadJ_Mu0;
  ...
  TH2D *h2_STMET_2to3HadJ_Mu1; TH2D *h2_STMET_2to3HadJ_Mu1_fb;
  TH2D *h2_STMET_min4HadJ_Mu1;
  TH2D *h2_STMET_2to3HadJ_Mu1_R[6];
  TH2D *h2_STHadJ_Mu1;
...
void LostMuon::BookHistogram(const char *outFileName) {
  ...
  h2_METnHadJ_Mu0=new TH2D("METnHadJ_Mu0","x: MET vs nHadJets for 0 Mu events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]),nHadJLow.size()-1,&(nHadJLow[0]));
  ...
  h2_STMET_2to3HadJ_Mu0=new TH2D("STMET_2to3HadJ_Mu0","x:ST vs MET for 2or3 HadJets and 0 Mu events",STLowEdge2.size()-1,&(STLowEdge2[0]),METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h2_STMET_min4HadJ_Mu0=new TH2D("STMET_min4HadJ_Mu0","x:ST vs MET for min 4 HadJets and 0 Mu events",STLowEdge4.size()-1,&(STLowEdge4[0]),METBinLowEdge4.size()-1,&(METBinLowEdge4[0]));
  ...
  h2_STMET_2to3HadJ_Mu0_fb=new TH2D("STMET_2to3HadJ_Mu0_fb","x:ST MET_2to3HadJ_Mu1_fb 0 Mu events",500,0,5000,200,0,2000);
 
  h2_STMET_2to3HadJ_Mu0_R[0]=new TH2D("STMET_2to3HadJ_Mu0_R1","x:ST vs MET for 2or3 HadJets and 0 Mu events region 1",1,500,550,METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h2_STMET_2to3HadJ_Mu0_R[1]=new TH2D("STMET_2to3HadJ_Mu0_R2","x:ST vs MET for 2or3 HadJets and 0 Mu events region 2",1,550,600,2,100,180);
  h2_STMET_2to3HadJ_Mu0_R[2]=new TH2D("STMET_2to3HadJ_Mu0_R3","x:ST vs MET for 2or3 HadJets and 0 Mu events region 3",1,550,720,1,180,250);
  h2_STMET_2to3HadJ_Mu0_R[3]=new TH2D("STMET_2to3HadJ_Mu0_R4","x:ST vs MET for 2or3 HadJets and 0 Mu events region 4",1,550,720,1,250,5000);
  h2_STMET_2to3HadJ_Mu0_R[4]=new TH2D("STMET_2to3HadJ_Mu0_R5","x:ST vs MET for 2or3 HadJets and 0 Mu events region 5",1,600,720,2,100,180);
  h2_STMET_2to3HadJ_Mu0_R[5]=new TH2D("STMET_2to3HadJ_Mu0_R6","x:ST vs MET for 2or3 HadJets and 0 Mu events region 6",1,720,5000,1,100,5000);
  ...
  h_myMT=new TH1D("MT_Mu","MT for 1 Mu events",500,0,500);
  ...
  h2_METnHadJ_Mu1=new TH2D("METnHadJ_Mu1","x: MET vs nHadJets for 1 Mu events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]),nHadJLow.size()-1,&(nHadJLow[0]));
  ...
  h2_STMET_2to3HadJ_Mu1=new TH2D("STMET_2to3HadJ_Mu1","x:ST vs MET for 2or3 HadJets and 1 Mu events",STLowEdge2.size()-1,&(STLowEdge2[0]),METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h2_STMET_min4HadJ_Mu1=new TH2D("STMET_min4HadJ_Mu1","x:ST vs MET for min 4 HadJets and 1 Mu events",STLowEdge4.size()-1,&(STLowEdge4[0]),METBinLowEdge4.size()-1,&(METBinLowEdge4[0]));
  ...
  h2_STMET_2to3HadJ_Mu1_fb=new TH2D("STMET_2to3HadJ_Mu1_fb","x:ST MET_2to3HadJ_Mu1_fb 1 Mu events",500,0,5000,200,0,2000);

  h2_STMET_2to3HadJ_Mu1_R[0]=new TH2D("STMET_2to3HadJ_Mu1_R1","x:ST vs MET for 2or3 HadJets and 1 Mu events region 1",1,500,550,METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h2_STMET_2to3HadJ_Mu1_R[1]=new TH2D("STMET_2to3HadJ_Mu1_R2","x:ST vs MET for 2or3 HadJets and 1 Mu events region 2",1,550,600,2,100,180);
  h2_STMET_2to3HadJ_Mu1_R[2]=new TH2D("STMET_2to3HadJ_Mu1_R3","x:ST vs MET for 2or3 HadJets and 1 Mu events region 3",1,550,720,1,180,250);
  h2_STMET_2to3HadJ_Mu1_R[3]=new TH2D("STMET_2to3HadJ_Mu1_R4","x:ST vs MET for 2or3 HadJets and 1 Mu events region 4",1,550,720,1,250,5000);
  h2_STMET_2to3HadJ_Mu1_R[4]=new TH2D("STMET_2to3HadJ_Mu1_R5","x:ST vs MET for 2or3 HadJets and 1 Mu events region 5",1,600,720,2,100,180);
  h2_STMET_2to3HadJ_Mu1_R[5]=new TH2D("STMET_2to3HadJ_Mu1_R6","x:ST vs MET for 2or3 HadJets and 1 Mu events region 6",1,720,5000,1,100,5000);
  ...
  //---------------- search bins -----------------------
  h_MET_Mu0_R[0] = new TH1D("MET_Mu0_R1","MET: NJ=2to4, ST=500to1500 for 0 Mu events",METBinLowEdge.size()-1,&(METBinLowEdge[0]));
  h_MET_Mu0_R[1] = new TH1D("MET_Mu0_R2","MET: NJ=5or6, ST=500to1500 for 0 Mu events",METBinLowEdge.size()-1,&(METBinLowEdge[0]));
  h_MET_Mu0_R[2] = new TH1D("MET_Mu0_R3","MET: NJ>=7,   ST=500to1500 for 0 Mu events",METBinLowEdge.size()-1,&(METBinLowEdge[0]));
  
  h_MET_Mu1_R[0] = new TH1D("MET_Mu1_R1","MET: NJ=2to4, ST=500to1500 for 1 Mu events",METBinLowEdge.size()-1,&(METBinLowEdge[0]));
  h_MET_Mu1_R[1] = new TH1D("MET_Mu1_R2","MET: NJ=5or6, ST=500to1500 for 1 Mu events",METBinLowEdge.size()-1,&(METBinLowEdge[0]));
  h_MET_Mu1_R[2] = new TH1D("MET_Mu1_R3","MET: NJ>=7,   ST=500to1500 for 1 Mu events",METBinLowEdge.size()-1,&(METBinLowEdge[0]));
