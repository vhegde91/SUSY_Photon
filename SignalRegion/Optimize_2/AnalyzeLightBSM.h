...
class AnalyzeLightBSM : public NtupleVariables{
 ...
 public:
  ...
  vector<double> METBinLowEdge_v4={0,20,40,60,80,100,120,160,200,300,500,750,900};//{0,20,40,60,80,100,125,160,200,300,500,700,800}
  ...
  TH1D *h_MET_R_v2[5];
  TH1D *h_SBins,*h_SBins_v1,*h_SBins_v3,*h_SBins_v4,*h_SBins_v5,*h_SBins_v6;
...
void AnalyzeLightBSM::BookHistogram(const char *outFileName) {
  ...
  h_SBins_v4 = new TH1D("AllSBins_v4","search bins: [ NJ:2-4, NJ:5or6, NJ>=7] x [0b, >=1b]",42,0.5,42.5);
  h_SBins_v5 = new TH1D("AllSBins_v5","search bins(MET merged): [ NJ:2-4, NJ:5or6, NJ>=7] x [0b, 1b, >=2b]",51,0.5,51.5);
  h_SBins_v6 = new TH1D("AllSBins_v6","search bins: [ NJ:2-4, NJ:5or6] x [0b, 1b], NJ>=7",35,0.5,35.5);
}
