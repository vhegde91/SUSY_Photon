...
class AnalyzeLightBSM : public NtupleVariables{
 ...
 public:
  ...
  vector<double> METBinLowEdge2={0,20,40,60,80,100,125,150,200,250,350,500,600};
...
void AnalyzeLightBSM::BookHistogram(const char *outFileName) {
  ...
  h_MET_R_v2[0] =new TH1D("MET_R1_v2","MET for 0b, NJ=2to4",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_R_v2[1] =new TH1D("MET_R2_v2","MET for 0b, NJ>=5",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_R_v2[2] =new TH1D("MET_R3_v2","MET for 1b, NJ=2to4",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_R_v2[3] =new TH1D("MET_R4_v2","MET for 1b, NJ>=5",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_R_v2[4] =new TH1D("MET_R5_v2","MET for b>=2",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
