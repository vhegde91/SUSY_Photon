...
int col[11]={kPink+1,kTeal+9,kGreen,kYellow,kOrange,kPink-2,kBlue,kCyan,kRed,kBlue+2,kMagenta};  //Specify Colors b's
...
TLegend *legend1=new TLegend(0.35, 0.85,  0.88, 0.72);
...
void plotKinStack(){
  ...
  f[4] = new TFile("WGJetsToLNuG.root");
...
void drawlegend(TH1D *hist,int i,const char* fname){
  ...
  if(lName.Contains("ZJetsToNuNu")){lName="Z(#nu#bar{#nu})+jets";}
