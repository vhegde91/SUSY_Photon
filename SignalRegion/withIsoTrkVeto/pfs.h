...
// Mon Aug 21 17:13:54 2017 by ROOT version 6.04/02
// from TTree PreSelection/PreSelection
// found on file: gjet16_RA2AnalysisTree_pfInfo.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<TLorentzVector> *L1EGObjects;
   Double_t        madHT;
...
#ifdef pfs_cxx
pfs::pfs(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gjet16_RA2AnalysisTree_pfInfo.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("gjet16_RA2AnalysisTree_pfInfo.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("gjet16_RA2AnalysisTree_pfInfo.root:/TreeMaker2");
...
Int_t pfs::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pfs::LoadTree(Long64_t entry)
{
...
void pfs::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("L1EGObjects", &L1EGObjects, &b_L1EGObjects);
   ...
   fChain->SetBranchAddress("PFCands_charge", &PFCands_charge, &b_PFCands_charge);
