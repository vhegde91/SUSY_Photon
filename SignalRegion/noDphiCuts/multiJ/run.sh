...
#./multijet runList_ZJetsToNuNu.txt ZJetsToNuNu.root nonprompt
#./multijet runList_ZGJetsToNuNuG.txt ZGJetsToNuNuG.root prompt
#./multijet runList_QCD.txt QCD.root nonprompt
#./multijet runList_GJets.txt GJets.root prompt
#./multijet runList_WJetsToLNu.txt WJetsToLNu.root WJetsToLNu
#./multijet runList_WGToLNuG.txt WGJetsToLNuG.root WG
#./multijet runList_TTJets.txt TTJetsHT.root TTJets_HT
#./multijet runList_TTGJets.txt TTGJets.root TTGJets
