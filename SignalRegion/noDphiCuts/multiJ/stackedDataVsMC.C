...
void stackedDataVsMC(TString iFname){
  ...
  name1.push_back("ST_AB");  rebin.push_back(10);   xLow.push_back(0); xHigh.push_back(3000); 
  //  name1.push_back("MET_AB");    rebin.push_back(2);    xLow.push_back(0); xHigh.push_back(800); 
  //  name1.push_back("nBTags_AB");   rebin.push_back(1);  xLow.push_back(0); xHigh.push_back(8);  
  name1.push_back("nHadJets_AB");  rebin.push_back(1);  xLow.push_back(0); xHigh.push_back(12);
  name1.push_back("BestPhotonPt_AB");   rebin.push_back(2); xLow.push_back(0); xHigh.push_back(1000);
  name1.push_back("BestPhotonEta_AB"); rebin.push_back(5);  xLow.push_back(-100000); xHigh.push_back(100000);
  name1.push_back("BestPhotonPhi_AB"); rebin.push_back(2);
  name1.push_back("METvarBin_AB");  rebin.push_back(1); xLow.push_back(-100000); xHigh.push_back(1000000);
  // name1.push_back("dPhi_METjet1_Pho_AB"); rebin.push_back(2); xLow.push_back(0); xHigh.push_back(100000);
  // name1.push_back("dPhi_METjet2_Pho_AB"); rebin.push_back(2); xLow.push_back(0); xHigh.push_back(100000);
  name1.push_back("dPhi_METBestPhoton_AB"); rebin.push_back(2);   xLow.push_back(0); xHigh.push_back(100000);
  name1.push_back("mTPho_AB");   rebin.push_back(5);    xLow.push_back(0); xHigh.push_back(800);

  name1.push_back("AllSBins_v7_AB");   rebin.push_back(1);   xLow.push_back(-10000); xHigh.push_back(300000);

  // name1.push_back("isoEleTrack_D");   rebin.push_back(1);
  // name1.push_back("isoMuTrack_D");   rebin.push_back(1);
  // name1.push_back("isoPiTrack_D");   rebin.push_back(1);
  // name1.push_back("MET_D_R1");rebin.push_back(1);
  // name1.push_back("MET_D_R2");rebin.push_back(1);
  // name1.push_back("MET_D_R3");rebin.push_back(1);
  ...
  for(int i=0;i<name1.size();i++){
    ...
    //    if(name.Contains("MuPt")) setMyRange(h_histG,xLow[i],xHigh[i]);
    if(name1[i]=="nHadJets_D") data_Integral=h_histG->Integral();
