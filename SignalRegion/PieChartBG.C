...
void PieChartBG(){
  ...
  for(int i=0;i<nfiles;i++){
    ...
    cout<<h_METvBin->GetTitle()<<" "<<f[i]->GetName()<<"\t"<<h_METvBin->Integral(minMETBin-1,h_METvBin->GetNbinsX()+1)<<" "<<minMETBin<<endl;
