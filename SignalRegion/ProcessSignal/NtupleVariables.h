...
// Tue Apr  5 12:54:08 2016 by ROOT version 6.04/02
// from TTree PreSelection/PreSelection
// found on file: GMSB_skims/signalRegionSkim_Spring15v2.WJetsToLNu_HT-800To1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_RA2AnalysisTree.root
//////////////////////////////////////////////////////////
...
void NtupleVariables::Init(TTree *tree, string nameData)
{
  ...
  if(nameData!="signal") fChain->SetBranchAddress("BadChargedCandidateFilter", &BadChargedCandidateFilter, &b_BadChargedCandidateFilter);
  if(nameData!="signal") fChain->SetBranchAddress("BadPFMuonFilter", &BadPFMuonFilter, &b_BadPFMuonFilter);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("BTagsJERdown", &BTagsJERdown, &b_BTagsJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("BTagsJERup", &BTagsJERup, &b_BTagsJERup);
  ...
  /* if(nameData!="signal") fChain->SetBranchAddress("BTagsMVAJERdown", &BTagsMVAJERdown, &b_BTagsMVAJERdown); */
  if(nameData!="signal") fChain->SetBranchAddress("BTagsMVAJERup", &BTagsMVAJERup, &b_BTagsMVAJERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("DeltaPhi1JERdown", &DeltaPhi1JERdown, &b_DeltaPhi1JERdown);
  if(nameData!="signal") fChain->SetBranchAddress("DeltaPhi1JERup", &DeltaPhi1JERup, &b_DeltaPhi1JERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("DeltaPhi2JERdown", &DeltaPhi2JERdown, &b_DeltaPhi2JERdown);
  if(nameData!="signal") fChain->SetBranchAddress("DeltaPhi2JERup", &DeltaPhi2JERup, &b_DeltaPhi2JERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("DeltaPhi3JERdown", &DeltaPhi3JERdown, &b_DeltaPhi3JERdown);
  if(nameData!="signal") fChain->SetBranchAddress("DeltaPhi3JERup", &DeltaPhi3JERup, &b_DeltaPhi3JERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("DeltaPhi4JERdown", &DeltaPhi4JERdown, &b_DeltaPhi4JERdown);
  if(nameData!="signal") fChain->SetBranchAddress("DeltaPhi4JERup", &DeltaPhi4JERup, &b_DeltaPhi4JERup);
  ...
  if(nameData!="signal")  fChain->SetBranchAddress("globalTightHalo2016Filter", &globalTightHalo2016Filter, &b_globalTightHalo2016Filter);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("HTJERdown", &HTJERdown, &b_HTJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("HTJERup", &HTJERup, &b_HTJERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("HTJetsMaskJERdown", &HTJetsMaskJERdown, &b_HTJetsMaskJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("HTJetsMaskJERup", &HTJetsMaskJERup, &b_HTJetsMaskJERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("JetIDJERdown", &JetIDJERdown, &b_JetIDJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("JetIDJERup", &JetIDJERup, &b_JetIDJERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERdown", &JetsJERdown, &b_JetsJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERdown_bDiscriminatorCSV", &JetsJERdown_bDiscriminatorCSV, &b_JetsJERdown_bDiscriminatorCSV);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERdown_bDiscriminatorMVA", &JetsJERdown_bDiscriminatorMVA, &b_JetsJERdown_bDiscriminatorMVA);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERdown_hadronFlavor", &JetsJERdown_hadronFlavor, &b_JetsJERdown_hadronFlavor);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERdown_ID", &JetsJERdown_ID, &b_JetsJERdown_ID);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERdown_partonFlavor", &JetsJERdown_partonFlavor, &b_JetsJERdown_partonFlavor);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERup", &JetsJERup, &b_JetsJERup);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERup_bDiscriminatorCSV", &JetsJERup_bDiscriminatorCSV, &b_JetsJERup_bDiscriminatorCSV);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERup_bDiscriminatorMVA", &JetsJERup_bDiscriminatorMVA, &b_JetsJERup_bDiscriminatorMVA);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERup_hadronFlavor", &JetsJERup_hadronFlavor, &b_JetsJERup_hadronFlavor);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERup_ID", &JetsJERup_ID, &b_JetsJERup_ID);
  if(nameData!="signal") fChain->SetBranchAddress("JetsJERup_partonFlavor", &JetsJERup_partonFlavor, &b_JetsJERup_partonFlavor);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("MHTJERdown", &MHTJERdown, &b_MHTJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("MHTJERup", &MHTJERup, &b_MHTJERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("MHTJetsMaskJERdown", &MHTJetsMaskJERdown, &b_MHTJetsMaskJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("MHTJetsMaskJERup", &MHTJetsMaskJERup, &b_MHTJetsMaskJERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("MHTPhiJERdown", &MHTPhiJERdown, &b_MHTPhiJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("MHTPhiJERup", &MHTPhiJERup, &b_MHTPhiJERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("NJetsJERdown", &NJetsJERdown, &b_NJetsJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("NJetsJERup", &NJetsJERup, &b_NJetsJERup);
  ...
  if(nameData!="signal") fChain->SetBranchAddress("softJetsJERdown", &softJetsJERdown, &b_softJetsJERdown);
  if(nameData!="signal") fChain->SetBranchAddress("softJetsJERdown_ID", &softJetsJERdown_ID, &b_softJetsJERdown_ID);
  if(nameData!="signal") fChain->SetBranchAddress("softJetsJERup", &softJetsJERup, &b_softJetsJERup);
  if(nameData!="signal") fChain->SetBranchAddress("softJetsJERup_ID", &softJetsJERup_ID, &b_softJetsJERup_ID);
  ...
  if(nameData=="signal") fChain->SetBranchAddress("METPt", &METPt, &b_METPt);
  Notify();
}
