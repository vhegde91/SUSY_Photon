...
void plotManyHists(){
  ...
  // rebin.push_back(1);
  //-------------------------------------
  fNames.push_back("bTagStudy_VetoWtob_TTJetsHT600ToInf.root");
  histName.push_back("nGenbs_0l");
  legName.push_back("0l");
  rebin.push_back(1);
  //-------------------------------------
  ...
  // rebin.push_back(1);
  fNames.push_back("bTagStudy_VetoWtob_TTJetsHT600ToInf.root");
  histName.push_back("nGenbs_2l");
  legName.push_back("2l");
  rebin.push_back(1);
  //-------------------------------------
  //-------------------------------------
  // fNames.push_back("");
...
void makeRatioPlot(){
  ...
  TPad *p_bot=new TPad("CB_bot","CB_bot",0,0.05,1,0.4);
  ...
  TH1D *h0cp=(TH1D*)h1[0]->Clone("h0cp");
  TH1D *h1cp=(TH1D*)h1[1]->Clone("h1cp");
  h0cp->GetXaxis()->SetTitleSize(0.08);
  h0cp->GetXaxis()->SetLabelSize(0.08);
  h0cp->GetYaxis()->SetTitleSize(0.08);
  h0cp->GetYaxis()->SetLabelSize(0.08);
  h0cp->Draw("histe");
  h1cp->Draw("sames histe");
  lg1->AddEntry(h0cp,legName[0],"lep");
  lg1->AddEntry(h1cp,legName[1],"lep");
  lg1->Draw();

  p_bot->cd();
  TH1D *h1_cp=(TH1D*)h1[0]->Clone("h1cp2");
  h1_cp->Divide(h1[1]);
  ...
  h1_cp->GetXaxis()->SetTitleOffset(0.5);
  h1_cp->GetXaxis()->SetLabelSize(0.12);
  //  h1_cp->GetYaxis()->SetTitle(yAxisName);
  h1_cp->GetYaxis()->SetTitleSize(0.12);
  h1_cp->GetYaxis()->SetLabelSize(0.12);
  h1_cp->GetYaxis()->SetTitleOffset(0.30);
  h1_cp->Draw();
  TFile *fout;
  if(saveHist){
