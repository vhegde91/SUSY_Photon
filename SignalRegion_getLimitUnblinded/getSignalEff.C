...
void getSignalEff(TString model){
  ...
  TString pathName="hists_LimitTree_"+model+"_SbinV7_Obs_v3/FastSim_"+model+"_"+model+"_",name;
  ...
  int minGlMass;
  if(model=="T5bbbbZg") minGlMass = 1400;
  else if(model=="T5ttttZg") minGlMass = 1400;
  else if(model=="T5qqqqHg") minGlMass = 1400;
  else if(model=="T6ttZg"  ) minGlMass =  300;
