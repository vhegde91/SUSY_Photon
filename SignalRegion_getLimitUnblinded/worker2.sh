...
combine -M ProfileLikelihood --significance dataCard_${anaArg}_${outName}_${gluinoMass}_${nlspMass}.txt -n ObsSignif_${outName}_${gluinoMass}_${nlspMass} -m ${mH} -s -1 --rMin -10
combine -M ProfileLikelihood --significance dataCard_${anaArg}_${outName}_${gluinoMass}_${nlspMass}.txt -t -1 --expectSignal=1 -n ExpSignif_${outName}_${gluinoMass}_${nlspMass} -m ${mH} -s -1 --rMin -10
##########################
