...
filesToTransfer="makeDatacard_SBinsV7_GGM.C,SBinHists.root,${anaExe},combineCards.py,higgsCombine.tar,PileupHistograms_0121_69p2mb_pm4p6.root,T5bbbbZg_MassScan.root,T5qqqqHg_MassScan.root,T5ttttZg_MassScan.root,T6ttZg_MassScan.root,SignalCont_T6ttZg_LostMu.root,SignalCont_T5ttttZg_LostMu.root,btagFiles.tar,SignalCont_GGM_M1M3_LostMu.root"
