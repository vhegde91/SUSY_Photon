...
void allBGPredVsData_v2(TString iFname){
  ...
  for(int i=1;i<=h_ratio->GetNbinsX();i++) if( i==1 || i==7 || i==12 || i==17 || i==22 || i==27 )h_ratio->SetBinError(i,1e-6);
  ...
  TLine *line1V7=new TLine( 6.5,0.01,  6.5,200000);
  TLine *line2V7=new TLine(11.5,0.01, 11.5,200000);
  TLine *line3V7=new TLine(16.5,0.01, 16.5,1000);
  TLine *line4V7=new TLine(21.5,0.01, 21.5,1000);
  TLine *line5V7=new TLine(26.5,0.01, 26.5,1000 );
