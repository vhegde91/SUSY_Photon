...
void postFitBased_BGHists(){
  c_postFitBased_BGHists c1;
  c1.setFileNames();
...
void c_postFitBased_BGHists::setFileNames(){
  ...
  fOutName = "postFitBased_SBinHists.root";

  fout = new TFile(fOutName,"recreate");
}

void c_postFitBased_BGHists::getLEleHist(int i_f){
  ...
  //-------------post-fit---------------
  if(usePostfit && !isLDP){
    hCS->SetBinContent(3,(0.37)*hCS->GetBinContent(3));
    hCS->SetBinError(3,0.89*hCS->GetBinError(3));
  }
  //------------------------------------
...
void c_postFitBased_BGHists::getLMuTauHist(int i_f){
  bool isLDP = (fName[i_f].Contains("LDP"));
  fl = TFile::Open(fName[i_f]);
  TFile *flUnc;
  ...
  //-------------post-fit---------------
  if(usePostfit && !isLDP){
    hTF->SetBinContent(3,(0.37)*hTF->GetBinContent(3));
    hTF->SetBinError(3,0.98*hTF->GetBinError(3));
  }
  //------------------------------------
 ...
 //-------------post-fit---------------
  if(usePostfit && !isLDP){
    hCS->SetBinContent(3,(1.16)*hCS->GetBinContent(3));
    hCS->SetBinError(3,0.74*hCS->GetBinError(3));
  }
  //------------------------------------
...
void c_postFitBased_BGHists::getFRHist(int i_f){
  bool isLDP = (fName[i_f].Contains("LDP"));
  fl = TFile::Open(fName[i_f]);
  TFile *flUnc;
  ...
  //-------------post-fit---------------
  if(usePostfit && !isLDP){
    hFR->SetBinContent(3,(0.50)*hFR->GetBinContent(3));
    hFR->SetBinError(3,0.95*hFR->GetBinError(3));
  }
  //------------------------------------
  //-----get FR unc in SBins
...
void c_postFitBased_BGHists::getZGHist(int i_f){
  bool isLDP = (fName[i_f].Contains("LDP"));
  fl = TFile::Open(fName[i_f]);
  ...
  //-------------post-fit---------------
  if(usePostfit && !isLDP){
    hTF->SetBinContent(3,(0.80)*hTF->GetBinContent(3));
    hTF->SetBinError(3,0.84*hTF->GetBinError(3));
  }
  //------------------------------------
  ...
  //-------------post-fit---------------
  if(usePostfit && !isLDP){
    hPred->SetBinContent(3,(0.61)*hPred->GetBinContent(3));
    hPred->SetBinError(3,0.95*hPred->GetBinError(3));
  }
  //------------------------------------
...
void c_postFitBased_BGHists::getMultiJHist(int i_f){
  fl = TFile::Open(fName[i_f]);
  ...
  //-------------post-fit---------------
  if(usePostfit){
    hEWSum->SetBinContent(3,(0.61)*hEWSum->GetBinContent(3));
    hEWSum->SetBinError(3,0.95*hEWSum->GetBinError(3));
  }
  //------------------------------------
  ...
  //-------------post-fit---------------
  if(usePostfit){
    h_doubleR->SetBinContent(3,(0.72)*h_doubleR->GetBinContent(3));
    h_doubleR->SetBinError(3,0.93*h_doubleR->GetBinError(3));
  }
  //------------------------------------
  TH1D *h_MultiJPred = (TH1D*)hCS->Clone("AllSBins_v7_MultiJPred");
  //-------------post-fit---------------
  if(usePostfit){
    h_MultiJPred->SetBinContent(3,(0.46)*h_MultiJPred->GetBinContent(3));
    h_MultiJPred->SetBinError(3,0.95*h_MultiJPred->GetBinError(3));
  }
  //------------------------------------
...
void c_postFitBased_BGHists::getTotalBG(int i_f){
  fl = TFile::Open(fName[i_f]);
...
//------------------------------------------------
void c_postFitBased_BGHists::setNegContentsTo0(TH1D *h1){
  for(int i=1;i<=h1->GetNbinsX();i++){
...
void c_postFitBased_BGHists::printContents(TH1D *h1){
  bool showBinError=1;
...
/*
int c_postFitBased_BGHists::setLostMuTF(int nj, int nb, double met){
  double tf = -1, errTF = -1;
  if(nb==0){
    if(met >=100 && met < 150){
