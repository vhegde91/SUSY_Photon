...
root -l -q 'splitRunList.C("Summer16.TTJets_DiLept_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt",10)'
root -l -q 'splitRunList.C("Summer16.TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt",10)'
root -l -q 'splitRunList.C("Summer16.TTJets_SingleLeptFromTbar_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt",10)'
...
root -l -q 'splitRunList.C("Summer16.ZGTo2LG_PtG-130_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.txt",10)'
root -l -q 'splitRunList.C("Summer16.ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext1.txt",10)'
root -l -q 'splitRunList.C("Summer16.ZGTo2NuG_PtG-130_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.txt",10)'
