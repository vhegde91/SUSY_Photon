...
TLegend *legend1=new TLegend(0.35,0.2,0.55,0.65);
TString xAxisLabel;
char name[100];
...
void GetEfficiency(){
  ...
  int nfiles=9;
  TFile *f[nfiles];
  TString saveFileName = "Run2016_MET_HT800or900_2016H_HT800or900orCaloJet500";
  TString name="PhoTrg";
  ...
  cA->SaveAs(saveFileName+".png");
  cA->SaveAs(saveFileName+".pdf");
