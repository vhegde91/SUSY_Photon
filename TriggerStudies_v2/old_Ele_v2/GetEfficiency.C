...
void GetEfficiency(){
  ...
  // f[0] = new TFile("Run2016CtoH_MET_03Feb2017_SingEleTrg_NoIsoTightID_ST500_v2.root");
  // f[0] = new TFile("Run2016B_MET_03Feb2017_SingEleTrg_NoIsoTightID_ST500_v2.root");
  // f[1] = new TFile("Run2016C_MET_03Feb2017_SingEleTrg_NoIsoTightID_ST500_v2.root");
  // f[2] = new TFile("Run2016D_MET_03Feb2017_SingEleTrg_NoIsoTightID_ST500_v2.root");
  // f[3] = new TFile("Run2016E_MET_03Feb2017_SingEleTrg_NoIsoTightID_ST500_v2.root");
  // f[4] = new TFile("Run2016F_MET_03Feb2017_SingEleTrg_NoIsoTightID_ST500_v2.root");
  // f[5] = new TFile("Run2016G_MET_03Feb2017_SingEleTrg_NoIsoTightID_ST500_v2.root");
  // f[6] = new TFile("Run2016H_MET_03Feb2017_SingEleTrg_NoIsoTightID_ST500_v2.root");

  f[0] = new TFile("Run2016_MET_03Feb2017_CaloJet500_AtLeast1TightEle.root");
  ...
  for(int i=0;i<nfiles;i++){
    ...
    // histName1.push_back("Ele1Eta_Req");
    // histName2.push_back("Ele1Eta");
