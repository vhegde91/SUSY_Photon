...
void GetFakeRate(TString iFname){
  ...
  name1.push_back("nBTags_Pho");          name2.push_back("nBTags_Ele");      rebin.push_back(10);
  ...
  name1.push_back("F_ElePhi_Pho");          name2.push_back("F_ElePhi_Ele");      rebin.push_back(2);
  ...
  name1.push_back("QMultJetEler_Pho");          name2.push_back("QMultJetEler_Ele");      rebin.push_back(2);
  ...
  //  name1_2d.push_back("ElefPtElerPt_Ele");   name2_2d.push_back("ElefPtElerPt_Ele");
