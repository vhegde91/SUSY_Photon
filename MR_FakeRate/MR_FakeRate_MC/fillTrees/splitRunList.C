...
void splitRunList(string infile,int nfPerJob){
  ...
  string exeAna     = "measureFR";
  string datasetAna = "MS_FR_Tree";
  string rootFilesToTransfer = "PileupHistograms_0121_69p2mb_pm4p6.root";//give the name of the files seperated by comma(,). Ex:("a.root,b.root")
  //---------------------------------------------------
