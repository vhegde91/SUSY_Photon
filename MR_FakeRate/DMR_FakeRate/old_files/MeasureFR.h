...
void MeasureFR::BookHistogram(const char *outFileName) {
  ...
  h_mTPrbMET_ee=new TH1D("mTProbeMET_ee","mT(probe em obj,MET) for ee events",200,0,2000);
  ...
  h_mTPrbMET_ge=new TH1D("mTProbeMET_ge","mT(probe em obj,MET) for ge events",200,0,2000);
  ...
  //---------------------------------------------------
  h2_PhoPtVtx=new TH2D("PhoPtVtx","x:Photon Pt vs num of vertices for e(->#gamma)e events",7,ptLow2,6,nVtxLow);
  h2_ElePtVtx=new TH2D("ElePtVtx","x:Electron Pt vs num of vertices for ee events",7,ptLow2,6,nVtxLow);
