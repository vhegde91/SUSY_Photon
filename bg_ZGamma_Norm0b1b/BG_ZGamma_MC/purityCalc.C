void purityCalc(){
  ...
  vector<double> den={500, 31, 36, 31.+5.,            31.,        5.,       23.53+0.11, 2.55+0.47, 26.08+0.58};
  vector<double> num={480, 30, 35, 36-0.11101-0.4718, 31-0.11101, 5-0.4718, 23.53,      2.55,      26.08};
