...
void GetTF_ZG(){
  ...
  // TFile *fn=new TFile("Summer16.ZGTo2NuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_OnZ.root");
  // TFile *fd=new TFile("Summer16.ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext1_OnZ.root");

  // TFile *fn=new TFile("Summer16.ZGTo2LG_PtG-130_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_OnZ.root");
  // TFile *fd=new TFile("Summer16.ZGTo2NuG_PtG-130_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_OnZ.root");
  ...
  name2.push_back("invMass");  rebin.push_back(2);
