...
const int nfiles=4,nBG=4;    //Specify no. of files
TFile *f[nfiles];
...
void dPhiPlots(){
  ...
  f[0] = new TFile("CS_ZGToNuNuG.root");
  f[1] = new TFile("CS_ZJetsToNuNu.root");
  f[2] = new TFile("CS_ZGToLLG.root");
  f[3] = new TFile("CS_DYJetsToLL.root");
