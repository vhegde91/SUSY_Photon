...
void compDataVsMC(TString iFname){
  ...
  f[1] = new TFile("CS_TTW_LostMuHadTau.root");
  //  gStyle->SetOptStat("nemri");
  
  vector<string> name1;
  vector<int> rebin;
  name1.push_back("ST_Mu1");  rebin.push_back(25);         //name2.push_back("ST_Mu1");     
  ...
  name1.push_back("BestPhotonPt_Mu1");   rebin.push_back(10);  //name2.push_back("BestPhotonPt_Mu1");      
