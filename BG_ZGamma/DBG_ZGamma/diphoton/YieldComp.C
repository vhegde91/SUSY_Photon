...
void YieldComp(){
  ...
  const int nfiles=5;
  TFile *f[nfiles];
  f[0] = new TFile("CS_TTW_LostMuHadTau.root");
  f[1] = new TFile("CS_TTW_LostMuHadTau_TrgMET100PhoPt135_or_PhoPt165.root");
  f[2] = new TFile("CS_TTW_LostMuHadTau_TrgHT600PhoPt90_or_PhoPt135MET100.root");
  f[3] = new TFile("CS_TTW_LostMuHadTau_TrgHT600PhoPt90_or_PhoPt165.root");
  f[4] = new TFile("CS_TTW_LostMuHadTau_TrgHT300MET100_or_PhoPt165.root");
  TH1D *h_CR[nfiles],*h_SR[nfiles];
  TString name1;
  ...
  TCanvas *c_cA=new TCanvas("yield","yield in search bins",2000,900);
