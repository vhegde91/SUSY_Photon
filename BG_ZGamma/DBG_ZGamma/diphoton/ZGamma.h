...
void ZGamma::BookHistogram(const char *outFileName) {
  ...
  h_cutFlow=new TH1D("cutFlow","cutFlow 1:passed 2 photon, 2:passed e/mu/isoTrack veto, 3:passed trigger, 4: passed trigger eff cuts, 5:passed MET*,ST,nJ,dPhi, 6:passed MET<100",10,0,10);
  ...
  h_NextBestPhotonPt=new TH1D("NextBestPhotonPt","Pt of the 2nd best photon di-lepton(OS) events",150,0,1500);
