...
// Mon Dec 18 16:13:10 2017 by ROOT version 6.10/02
// from TTree PreSelection/PreSelection
// found on file: Run2016B-03Feb2017_ver2-v2.SinglePhoton_292_RA2AnalysisTree.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Run2016B-03Feb2017_ver2-v2.SinglePhoton_292_RA2AnalysisTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Run2016B-03Feb2017_ver2-v2.SinglePhoton_292_RA2AnalysisTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Run2016B-03Feb2017_ver2-v2.SinglePhoton_292_RA2AnalysisTree.root:/TreeMaker2");
