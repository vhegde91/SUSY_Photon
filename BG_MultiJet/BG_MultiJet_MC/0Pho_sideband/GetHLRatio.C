...
void GetHLRatio(TString inFname){
  ...
  name1_2d.push_back("METnHadJ_0b_v2_CD"); name2_2d.push_back("METnHadJ_0b_v2_AB");
  name1_2d.push_back("METnHadJ_min1b_v2_CD"); name2_2d.push_back("METnHadJ_min1b_v2_AB");
  ...
  for(int i=0;i<name1.size();i++){
    ...
    h_numr->Draw("e0");
    TString hname1=h_numr->GetName();hname1=hname1+"_"+h_histE->GetName();
    TH1D *h_ratio=(TH1D*)h_numr->Clone(hname1);
    fout->cd();
    h_ratio->Write();
