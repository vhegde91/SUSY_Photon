...
class MultiJet : public NtupleVariables{
 ...
 public:
  ...
  void print(Long64_t);
  int findObjMatchedtoG(TLorentzVector);
  ...
  vector<double> nJBinLow={0,1,2,3,4,5,6,7,20}, nJBinLow2={0,2,5,7,20};
  ...
  TH1D *h_MET2_AB,*h_MET2_CD,*h_MET2_[4];
  ...
  TH1D *h_dPhi_METPhoton2J_AB,*h_dPhi_METPhoton2J_CD,*h_dPhi_METPhoton2J_[4];
  TH1D *h_dPhi_METPhoton3J_AB,*h_dPhi_METPhoton3J_CD,*h_dPhi_METPhoton3J_[4];
  TH1D *h_dPhi_METPhoton4J_AB,*h_dPhi_METPhoton4J_CD,*h_dPhi_METPhoton4J_[4];
  TH1D *h_dPhi_METPhoton5to6J_AB,*h_dPhi_METPhoton5to6J_CD,*h_dPhi_METPhoton5to6J_[4];
  TH1D *h_dPhi_METPhoton7J_AB,*h_dPhi_METPhoton7J_CD,*h_dPhi_METPhoton7J_[4];
  ...
  TH2D *h2_MET2vsWt_AB,*h2_MET2vsWt_CD,*h2_MET2vsWt_[4];
  TH2D *h2_GenMET2vsWt_AB,*h2_GenMET2vsWt_CD,*h2_GenMET2vsWt_[4];
  TH2D *h2_SBins_v4_vsEvtWt_AB,*h2_SBins_v4_vsEvtWt_CD;
  ...
  TH2D *h2_METnHadJ_0b_v2_AB,*h2_METnHadJ_0b_v2_CD;
  TH2D *h2_METnHadJ_min1b_v2_AB,*h2_METnHadJ_min1b_v2_CD;
...
void MultiJet::BookHistogram(const char *outFileName) {
  ...
  h_MET2_AB=new TH1D("MET2_AB","MET_AB",1000,0,10000);
  ...
  h2_GenMET2vsWt_AB=new TH2D("GenMETvsWt_AB","x:GenMET vs event weights for 35.9/fb_AB",1000,0,1000,1000,0,100);
  h2_MET2vsWt_AB=new TH2D("METvsWt_AB","x:MET vs event weights for 35.9/fb_AB",1000,0,10000,1000,0,100);
  h2_SBins_v4_vsEvtWt_AB=new TH2D("SBins_v4_vsEvtWt_AB","x: search bins v4 vs event weights for 35.9/fb_AB",31,0.5,31.5,1000,0,100);
  ...
  h2_METnHadJ_0b_v2_AB=new TH2D("METnHadJ_0b_v2_AB","x:MET vs nHadJets_0b_v2_AB",METLowSimple.size()-1,&(METLowSimple[0]),nJBinLow2.size()-1,&(nJBinLow2[0]));
  h2_METnHadJ_min1b_v2_AB=new TH2D("METnHadJ_min1b_v2_AB","x:MET vs nHadJets_min1b_v2_AB",METLowSimple.size()-1,&(METLowSimple[0]),nJBinLow2.size()-1,&(nJBinLow2[0]));
  ...
  h_dPhi_METPhoton2J_AB=new TH1D("dPhi_METBestPhoton2J_AB","dphi between MET and BestPhoton_AB for 2J events",40,0,4);
  h_dPhi_METPhoton3J_AB=new TH1D("dPhi_METBestPhoton3J_AB","dphi between MET and BestPhoton_AB for 3J events",40,0,4);
  h_dPhi_METPhoton4J_AB=new TH1D("dPhi_METBestPhoton4J_AB","dphi between MET and BestPhoton_AB for 4J events",40,0,4);
  h_dPhi_METPhoton5to6J_AB=new TH1D("dPhi_METBestPhoton5to6J_AB","dphi between MET and BestPhoton_AB for 5or6J events",40,0,4);
  h_dPhi_METPhoton7J_AB=new TH1D("dPhi_METBestPhoton7J_AB","dphi between MET and BestPhoton_AB for >=7J events",40,0,4);
  ...
  h_MET2_CD=new TH1D("MET2_CD","MET2_CD",1000,0,10000);
  ...
  h_dPhi_METPhoton2J_CD=new TH1D("dPhi_METBestPhoton2J_CD","dphi between MET and BestPhoton_CD for 2J events",40,0,4);
  h_dPhi_METPhoton3J_CD=new TH1D("dPhi_METBestPhoton3J_CD","dphi between MET and BestPhoton_CD for 3J events",40,0,4);
  h_dPhi_METPhoton4J_CD=new TH1D("dPhi_METBestPhoton4J_CD","dphi between MET and BestPhoton_CD for 4J events",40,0,4);
  h_dPhi_METPhoton5to6J_CD=new TH1D("dPhi_METBestPhoton5to6J_CD","dphi between MET and BestPhoton_CD for 5or6J events",40,0,4);
  h_dPhi_METPhoton7J_CD=new TH1D("dPhi_METBestPhoton7J_CD","dphi between MET and BestPhoton_CD for >=7J events",40,0,4);
  ...
  h2_GenMET2vsWt_CD=new TH2D("GenMETvsWt_CD","x:GenMET vs event weights for 35.9/fb_CD",1000,0,1000,1000,0,100);
  h2_MET2vsWt_CD=new TH2D("METvsWt_CD","x:MET vs event weights for 35.9/fb_CD",1000,0,10000,1000,0,100);
  h2_SBins_v4_vsEvtWt_CD=new TH2D("SBins_v4_vsEvtWt_CD","x: search bins v4 vs event weights for 35.9/fb_CD",31,0.5,31.5,1000,0,100);
  ...
  h2_METnHadJ_0b_v2_CD=new TH2D("METnHadJ_0b_v2_CD","x:MET vs nHadJets_0b_v2_CD",METLowSimple.size()-1,&(METLowSimple[0]),nJBinLow2.size()-1,&(nJBinLow2[0]));
  h2_METnHadJ_min1b_v2_CD=new TH2D("METnHadJ_min1b_v2_CD","x:MET vs nHadJets_min1b_v2_CD",METLowSimple.size()-1,&(METLowSimple[0]),nJBinLow2.size()-1,&(nJBinLow2[0]));
  ...
  for(int i=0;i<4;i++){
    ...
    h_MET2_[i]=new TH1D("MET2_"+regName,"MET_"+regName,1000,0,10000);
    ...
    h_dPhi_METPhoton2J_[i]=new TH1D("dPhi_METBestPhoton2J_"+regName,"dphi between MET and BestPhoton for 2J events_"+regName,40,0,4);
    h_dPhi_METPhoton3J_[i]=new TH1D("dPhi_METBestPhoton3J_"+regName,"dphi between MET and BestPhoton for 3J events_"+regName,40,0,4);
    h_dPhi_METPhoton4J_[i]=new TH1D("dPhi_METBestPhoton4J_"+regName,"dphi between MET and BestPhoton for 4J events_"+regName,40,0,4);
    h_dPhi_METPhoton5to6J_[i]=new TH1D("dPhi_METBestPhoton5to6J_"+regName,"dphi between MET and BestPhoton for 5or6J events_"+regName,40,0,4);
    h_dPhi_METPhoton7J_[i]=new TH1D("dPhi_METBestPhoton7J_"+regName,"dphi between MET and BestPhoton for >=7J events_"+regName,40,0,4);
    ...
    h2_GenMET2vsWt_[i]=new TH2D("GenMETvsWt_"+regName,"x:GenMET vs event weights for 35.9/fb_"+regName,1000,0,1000,1000,0,100);  
    h2_MET2vsWt_[i]=new TH2D("METvsWt_"+regName,"x:MET vs event weights for 35.9/fb_"+regName,1000,0,10000,1000,0,100);  
