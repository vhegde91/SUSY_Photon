...
void compPhoSamples(TString iFname){
  ...
  f[1] = new TFile("HLR_GJetsQCD.root");

  vector<string> name1,name2;
  vector<int> rebin;
  name1.push_back("AllSBins_v4_CD_AllSBins_v4_AB");   name2.push_back("AllSBins_v4_CD_AllSBins_v4_AB");rebin.push_back(1);
  name1.push_back("ST_C_ST_A");   name2.push_back("ST_C_ST_A");rebin.push_back(1);
  name1.push_back("MET_CD_MET_AB");   name2.push_back("MET_CD_MET_AB");rebin.push_back(1);
  name1.push_back("nHadJets_C_nHadJets_A");   name2.push_back("nHadJets_C_nHadJets_A");rebin.push_back(1);
  name1.push_back("BestPhotonPt_C_BestPhotonPt_A");   name2.push_back("BestPhotonPt_C_BestPhotonPt_A");rebin.push_back(1);
  name1.push_back("METvarBin_CD_METvarBin_AB");   name2.push_back("METvarBin_CD_METvarBin_AB");rebin.push_back(1);
  name1.push_back("nBTags_C_nBTags_A");   name2.push_back("nBTags_C_nBTags_A");rebin.push_back(1);
  name1.push_back("AllSBins_v1_CD_AllSBins_v1_AB");   name2.push_back("AllSBins_v1_CD_AllSBins_v1_AB");rebin.push_back(1);
