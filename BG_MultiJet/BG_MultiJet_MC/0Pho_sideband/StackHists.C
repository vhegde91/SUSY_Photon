...
int col[11]={kCyan,kTeal+9,kPink+1,kYellow,kOrange,kBlue,kRed,kBlue+2,kGreen,kMagenta+2,kMagenta};  //Specify Colors b's
...
void StackHists(){
  ...
  f[0] = new TFile("VS_TTG_WG_ZG_GJets_ST1000_v2.root");
  f[1] = new TFile("VS_SingleTop_ST1000_v2.root");
  f[2] = new TFile("VS_ZJetsToNuNu_ST1000_v2.root");
  f[3] = new TFile("VS_TTJets_ST1000_v2.root");
  f[4] = new TFile("VS_WJets_ST1000_v2.root");
  f[5] = new TFile("VS_QCD_ST1000_v2.root");
  f[6] = new TFile("VS_T5bbbbZg_1600_150_ST1000_v2.root");
  f[7] = new TFile("VS_T5bbbbZg_1600_1550_ST1000_v2.root");
...
void drawlegend(TH1D *hist,int i,const char* fname){
  ...
  */
  ...
  else if(lName.Contains("SingleTop")){lName="t+jets";}
  else if(lName.Contains("WJets")){lName="W(#rightarrowl#nu)+jets";}
  else if(lName.Contains("TTJets")){lName="t #bar{t}";}
  else if(lName.Contains("WGJetsToLNuG")){lName="W(#rightarrowl#nu)+#gamma";}
  ...
  else if(lName.Contains("TTG_WG_ZG_GJets")){lName="X+#gamma +jets";}
