...
void splitRunList(string infile,int nfPerJob){
  ...
  string rootFilesToTransfer = "HLR_VS_GJetsQCD_ST1000_v2.root,PileupHistograms_0121_69p2mb_pm4p6.root,HLR_VS_GJetsQCD_SR_Sele_v2.root,HLR_EW_Subtracted_DVS_2016_ST1000.root";
