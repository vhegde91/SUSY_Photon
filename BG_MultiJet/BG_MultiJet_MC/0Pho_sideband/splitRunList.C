...
void splitRunList(string infile,int nfPerJob){
  ...
  string exeAna     = "multijet";
  string datasetAna = "QCD";
  string rootFilesToTransfer = "HLR_VS_GJetsQCD_ST1000_v2.root,PileupHistograms_0121_69p2mb_pm4p6.root,HLR_VS_GJetsQCD_SR_Sele_v2.root,HLR_EW_Subtracted_DVS_2016_ST1000.root,dPhiPhoMET_ratioOfSRtoVR.root";
                               //give the name of the files seperated by comma(,). Ex:("a.root,b.root")
  TString fname1=infile;
  if(fname1.Contains("GJets")) datasetAna = "GJets";
  else if(fname1.Contains("QCD")) datasetAna = "QCD";
  else if(fname1.Contains("WG")) datasetAna = "WG";
  else if(fname1.Contains("ZG")) datasetAna = "ZG";
  else if(fname1.Contains("WJets")) datasetAna = "WJets";
  else if(fname1.Contains("TTJets")) datasetAna = "TTJets";
  else if(fname1.Contains("TTG")) datasetAna = "TTG";
  //  else if(fname1.Contains("TG")) datasetAna = "TG";
  else if(fname1.Contains("SingleTop")) datasetAna = "SingleTop";
  else if(fname1.Contains("ZJets")) datasetAna = "ZJets";
