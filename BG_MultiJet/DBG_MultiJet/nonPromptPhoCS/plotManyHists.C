...
void plotManyHists(){
  ...
  fNames.push_back("passTrg_idFail.root"); 
  histName.push_back("MET_AB");
  legName.push_back("Non-prompt #gamma(AB)");
  rebin.push_back(10);
  //-------------------------------------
  ...
  // rebin.push_back(1);
  //-------------------------------------
  fNames.push_back("NoTrg_idFail.root");
  histName.push_back("MET_AB");
