...
void plotManyHists(){
  ...
  histName.push_back("nBTags_AB");
  legName.push_back("SR #gamma(AB)");
  rebin.push_back(1);
  //-------------------------------------
  ...
  // rebin.push_back(1);
  //-------------------------------------
  fNames.push_back("VS_GJetsQCD_SR_selectn.root");//VS_GJetsQCD_ST1000.root");
  histName.push_back("nBTags_AB");
  legName.push_back("VR #gamma(AB)");
  rebin.push_back(1);
  fNames.push_back("VS_GJetsQCD_ST1000.root");
  histName.push_back("nBTags_AB");
  legName.push_back("VR #gamma(AB)ST>1000");
  rebin.push_back(1);
  //-------------------------------------
  //-------------------------------------
  // fNames.push_back("");
