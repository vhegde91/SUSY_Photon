...
class SkimmingSR : public NtupleVariables{
 ...
 public:
  ...
  SkimmingSR(const TString &inputFileList="foo.txt", const char *outFileName="histo.root",const char *dataset="data",const char* mGl="0",const char* mNLSP="0");
  ~SkimmingSR();
...
SkimmingSR::SkimmingSR(const TString &inputFileList, const char *outFileName, const char* dataset, const char* mGl, const char* mNLSP) {
