...
class SkimmingSR : public NtupleVariables{
 ...
 public:
  ...
  TH1D *h_met0,*h_mht0,*h_ht0,*h_nj0,*h_phopt0;
  TFile *oFile;
...
void SkimmingSR::BookHistogram() {
  ...
  h_met0 = new TH1D("met0","MET before any selection",5000,0,5000);
  h_mht0 = new TH1D("mht0","MHT before any selection",5000,0,5000);
  h_ht0 = new TH1D("ht0","HT before any selection",5000,0,5000);
  h_nj0 = new TH1D("nj0","NJ before any selection",50,0,50);
  h_phopt0 = new TH1D("phopt0","all photons Pt before any selection",5000,0,5000);
}
