...
void findFailedJobs(string arg){
  ...
  //  char ofileStart[300]="/eos/uscms/store/user/vhegde/GMSB_skims_ST_RA2b_TreesV12/CS_ZGamma_LooseST/CS_ZGToLLG_";
  //  char ofileStart[300]="/eos/uscms/store/user/vhegde/GMSB_skims_ST_RA2b_TreesV12/CS_ZGamma/CS_ZGToLLG_";
  char ofileStart[300]="/eos/uscms/store/user/vhegde/GMSB_skims_ST_RA2b_TreesV12/CS_ZGamma/CS_ZJetsToNuNu_";

  //  char ofileStart[300]="/eos/uscms/store/user/vhegde/GMSB_skims_ST_RA2b_TreesV12/CS_ZGamma/CS_ZGToLLG_PtG0To130_";
