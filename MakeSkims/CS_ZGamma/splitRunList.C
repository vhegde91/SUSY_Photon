...
void splitRunList(string infile,int nfPerJob){
  ...
  string exeAna     = "skimmingZGamma";
  TString datasetAna = infile;
  // if     (datasetAna.Contains("Summer16.ZGTo2NuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8"))          datasetAna = "CS_v2_NuNu_NLO_PtG0To130";
  // else if(datasetAna.Contains("Summer16.ZGTo2NuG_PtG-130_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8"))  datasetAna = "CS_v2_NuNu_NLO_PtG130";
  // else if(datasetAna.Contains("Summer16.ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_ext1"))      datasetAna = "CS_v2_LL_NLO_PtG0To130";
  // else if(datasetAna.Contains("Summer16.ZGTo2LG_PtG-130_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8"))   datasetAna = "CS_v2_LL_NLO_PtG130";
  // //  else if(datasetAna.Contains("Summer16.ZNuNuGJets_MonoPhoton_PtG-130_TuneCUETP8M1_13TeV-madgraph")) datasetAna = "CS_v2_NuNu_LO_PtG130";
  // //  else if(datasetAna.Contains("Summer16.ZLLGJets_MonoPhoton_PtG-130_TuneCUETP8M1_13TeV-madgraph"))   datasetAna = "CS_v2_LL_LO_PtG130";
  // else datasetAna = "CS_ZJetsToNuNu";
  datasetAna = "CS_ZJetsToNuNu";
  //---------------------------------------------------
