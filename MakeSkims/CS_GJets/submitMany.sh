#!/bin/sh
#root -l -q 'splitRunList.C("Summer16.DiPhotonJetsBox_M40_80_13TeV-Sherpa.txt",10)'
#root -l -q 'splitRunList.C("Summer16.DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa.txt",10)'
...
#root -l -q 'splitRunList.C("Summer16.ZGTo2NuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.txt",18)'
