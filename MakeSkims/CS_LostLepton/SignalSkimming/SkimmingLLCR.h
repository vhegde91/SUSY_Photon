#ifndef SkimmingLLCR_H
#define SkimmingLLCR_H
...
class SkimmingLLCR : public NtupleVariables{

 public:
  //  SkimmingLLCR(const TString &inputFileList="foo.txt", const char *outFileName="histo.root",const char *dataset="data");
  SkimmingLLCR(const TString &inputFileList="foo.txt", const char *outFileName="histo.root",const char *dataset="data",const char* mGl="0",const char* mNLSP="0");
  ~SkimmingLLCR();
...
#ifdef SkimmingLLCR_cxx

void SkimmingLLCR::BookHistogram() {
...
SkimmingLLCR::SkimmingLLCR(const TString &inputFileList, const char *outFileName, const char* dataset, const char* mGl, const char* mNLSP) {
...
Bool_t SkimmingLLCR::FillChain(TChain *chain, const TString &inputFileList) {
...
Long64_t SkimmingLLCR::LoadTree(Long64_t entry) {
