...
void splitRunList(string infile,int nfPerJob){
  ...
  string exeAna     = "skimmingLLCR";
  //  string datasetAna = "Signal";
  string filesToTransfer = "processSigFile.C,T5bbbbZg_MassScan.root,T5qqqqHg_MassScan.root,T5ttttZg_MassScan.root,TChiNG_MassScan.root,TChiWG_MassScan.root,T6ttZg_MassScan.root,GGM_M1M3_MassScan.root ";
  //---------------------------------------------------
  nfPerJob = 1;
