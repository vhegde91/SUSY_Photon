...
void findFailedJobs(string arg){
  ...
  TString infile2 = arg;
  string name3;
  if(infile2.Contains("TTJets_Tune")) name3 = "TTJets_Tune_";
  else if(infile2.Contains("TTJets_HT-600to800")) name3 = "TTJets_HT-600to800_";
  else if(infile2.Contains("TTJets_HT-800to1200")) name3 = "TTJets_HT-800to1200_";
  else if(infile2.Contains("TTJets_HT-1200to2500")) name3 = "TTJets_HT-1200to2500_";
  else if(infile2.Contains("TTJets_HT-2500toInf")) name3 = "TTJets_HT-2500toInf_";
  sprintf(ofileStart,"%s",name3.c_str());
