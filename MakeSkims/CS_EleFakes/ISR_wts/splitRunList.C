...
void splitRunList(string infile,int nfPerJob){
  ...
  string exeAna     = "skimmingFakeRate";
  string datasetAna;
  TString infile2 = infile;
  if(infile2.Contains("TTJets_Tune")) datasetAna = "TTJets_Tune";
  else if(infile2.Contains("TTJets_HT-600to800")) datasetAna = "TTJets_HT-600to800";
  else if(infile2.Contains("TTJets_HT-800to1200")) datasetAna = "TTJets_HT-800to1200";
  else if(infile2.Contains("TTJets_HT-1200to2500")) datasetAna = "TTJets_HT-1200to2500";
  else if(infile2.Contains("TTJets_HT-2500toInf")) datasetAna = "TTJets_HT-2500toInf";
  //---------------------------------------------------
