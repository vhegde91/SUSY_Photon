...
// Thu Feb 23 16:05:55 2017 by ROOT version 6.06/01
// from TTree PreSelection/PreSelection
// found on file: root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV12/Run2016H-03Feb2017_ver2-v1.SinglePhoton_338_RA2AnalysisTree.root
//////////////////////////////////////////////////////////
...
#ifdef data_var_cxx
data_var::data_var(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV12/Run2016H-03Feb2017_ver2-v1.SinglePhoton_338_RA2AnalysisTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV12/Run2016H-03Feb2017_ver2-v1.SinglePhoton_338_RA2AnalysisTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV12/Run2016H-03Feb2017_ver2-v1.SinglePhoton_338_RA2AnalysisTree.root:/TreeMaker2");
...
Int_t data_var::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t data_var::LoadTree(Long64_t entry)
{
...
void data_var::Show(Long64_t entry)
{
...
Int_t data_var::Cut(Long64_t entry)
{
