...
void compDataVsMC(TString iFname){
  ...
  f[1] = new TFile("CS_TTW_FR_v2.root");
  ...
  name1.push_back("EleEta");   rebin.push_back(1);  //name2.push_back("BestPhotonPt_Ele");
  name1.push_back("ElePhi");   rebin.push_back(5);  //name2.push_back("BestPhotonPt_Ele");      
  //  name1.push_back("BestPhotonEta_Ele"); rebin.push_back(10);  //name2.push_back("BestPhotonEta_Ele");  
  name1.push_back("METvarBin_Ele");  rebin.push_back(1); //name2.push_back("METvarBin_Ele");
  name1.push_back("Qmulti_Ele");  rebin.push_back(1); //name2.push_back("METvarBin_Ele");
  name1.push_back("nVtx_Ele");  rebin.push_back(2); //name2.push_back("METvarBin_Ele");
  name1.push_back("AllSBins_Ele");  rebin.push_back(1); //name2.push_back("METvarBin_Ele");  
  //  name1.push_back("invMassPhoMu");  rebin.push_back(1); //name2.push_back("METvarBin_Ele");  
  // name1.push_back("dPhi_METjet1_Pho_Ele"); rebin.push_back(1);  //name2.push_back("dPhi_METjet1_Pho_Ele");  
  // name1.push_back("dPhi_METjet2_Pho_Ele"); rebin.push_back(1);  //name2.push_back("dPhi_METjet2_Pho_Ele");  
  // name1.push_back("dPhi_METBestPhoton_Ele"); rebin.push_back(1);   //name2.push_back("dPhi_METBestPhoton_Ele");  
  // name1.push_back("dPhi_Muon_Photon"); rebin.push_back(2);
  // name1.push_back("MET_Ele_R1");         name2.push_back("MET_Ele_R1");rebin.push_back(1);
  ...
  for(int i=0;i<name1.size();i++){
    ...
    //!!!!!TH1D *h_numr=(TH1D*)h_histG->Clone();
    // if(name1[i]=="MET_Pho") {cout<<"numr Mu:"<<h_numr->GetBinContent(7)<<" numr error:"<<h_numr->GetBinError(7)<<" den pho:"<<h_histG->GetBinContent(7)<<" error:"<<h_histG->GetBinError(7)<<endl;
    // }
  ...
  //fout->cd();
  //  h2_histGcopy->Write();
  cout<<"Integral in Data(1 e events) "<<sr_Integral<<endl
      <<"Integral in MC(1 e events) "<<cr_Integral<<endl;
}
