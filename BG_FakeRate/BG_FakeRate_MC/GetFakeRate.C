...
void GetFakeRate(TString iFname){
  ...
  //  f[0] = new TFile("CS_TTJetsAll.root");
  // f[0] = new TFile("CS_TTJets_v2.root");
  //f[0] = new TFile("CS_WJetsToLNu_v2.root");
  //  f[0] = new TFile("CS_TTW_FR.root");
  ...
  name1.push_back("BestPhotonPhi");   name2.push_back("ElePhi");      rebin.push_back(1);
  ...
  name1.push_back("dPhi_METjet2_Pho");name2.push_back("dPhi_METjet2_Ele");rebin.push_back(4);
 ...
 // name1_2d.push_back("PhotonPtEtavBin");   name2_2d.push_back("ElePtEtavBin");
  ...
  // name1.push_back("dPhi_METjet1_Pho");name2.push_back("dPhi_METjet1_Ele");
  // name1.push_back("dPhi_METjet2_Pho");name2.push_back("dPhi_METjet2_Ele");
  ...
  for(int i=0;i<name1.size();i++){
	...
	h_histGcopy=(TH1D*)h_histG->Clone("FakeRate");
