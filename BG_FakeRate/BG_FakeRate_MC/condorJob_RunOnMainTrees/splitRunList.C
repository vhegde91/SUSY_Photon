...
void splitRunList(string infile,int nfPerJob){
  ...
  string rootFilesToTransfer = "PileupHistograms_0121_69p2mb_pm4p6.root,FR_Hist_CS_TTW_FR_v2.root";//give the name of the files seperated by comma(,). Ex:("a.root,b.root")
  //---------------------------------------------------
