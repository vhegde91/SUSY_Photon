...
class FakeRateEst : public NtupleVariables{
 ...
 public:
  ...
  TH1D *h_ST_Pho,*h_MET_Pho,*h_nHadJets_Pho,*h_BTags_Pho,*h_METvBin_Pho,*h_HT_Pho,*h_MHT_Pho,*h_nJets_Pho,*h_madHT_Pho,*h_nVtx_Pho;
  TH1D *h_ST_Ele,*h_MET_Ele,*h_nHadJets_Ele,*h_BTags_Ele,*h_METvBin_Ele,*h_HT_Ele,*h_MHT_Ele,*h_nJets_Ele,*h_madHT_Ele,*h_nVtx_Ele;
  ...
  double nVtxLow[7]={0,10,15,20,25,30,100};
...
void FakeRateEst::BookHistogram(const char *outFileName) {
  ...
  h_MET_Pho_R[0] = new TH1D("MET_Pho_R1","MET: NJ=2to4 for photon like events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_Pho_R[1] = new TH1D("MET_Pho_R2","MET: NJ=5or6 for photon like events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_Pho_R[2] = new TH1D("MET_Pho_R3","MET: NJ>=7 for photon like events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_Pho_Rall = new TH1D("MET_Pho_Rall","MET: NJets>=2 for photon like events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  ...
  h2_PhoPtVtx=new TH2D("PhoPtVtx","x:Photon Pt vs num of vertices",7,ptLow2,6,nVtxLow);
  ...
  h2_HadDRJptGptRatio_Vtx=new TH2D("HadDRJptGptRatio_Vtx","x:HadDR*JetPt/PhotonPt vs NVtx",sizeof(minDR_RatioLow)/sizeof(double)-1,minDR_RatioLow,6,nVtxLow);
  ...
  h3_PhoPtEtaVtx=new TH3D("PhoPtEtaVtx","x:Photon |Eta|, y:nVtx, z: Photon Pt",5,etaLow,6,nVtxLow,7,ptLow2);
  ...
  h3_JetPtVtxMinHadDR_Pho=new TH3D("JetPtVtxMinHadDR_Pho","x:Pt of jet close to photon, y:nVtx, z:dR b/w closest HadJet and photon",7,ptLow2,6,nVtxLow,sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  h3_PhoPtVtxMinHadDR=new TH3D("PhoPtVtxMinHadDR","x:Photon pT, y:Vtx, z:MinDR with HadJet",7,ptLow2,6,nVtxLow,sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  ...
  h_MET_Ele_R[0] = new TH1D("MET_Ele_R1","MET: NJ=2to4 for electron events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_Ele_R[1] = new TH1D("MET_Ele_R2","MET: NJ=5or6 for electron events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_Ele_R[2] = new TH1D("MET_Ele_R3","MET: NJ>=7 for electron events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  h_MET_Ele_Rall = new TH1D("MET_Ele_Rall","MET: NJets>=2 for electron events",METBinLowEdge2.size()-1,&(METBinLowEdge2[0]));
  ...
  h2_ElePtVtx=new TH2D("ElePtVtx","x:Electron Pt vs num of vertices",7,ptLow2,6,nVtxLow);
  ...
  h2_HadDRJptEptRatio_Vtx=new TH2D("HadDRJptEptRatio_Vtx","x:dR*JetPt/ElectronPt vs NVtx",sizeof(minDR_RatioLow)/sizeof(double)-1,minDR_RatioLow,6,nVtxLow);
  ...
  h3_ElePtEtaVtx=new TH3D("ElePtEtaVtx","x:Electron |Eta|, y:nVtx, z: Electron Pt",5,etaLow,6,nVtxLow,7,ptLow2);
  ...
  h3_JetPtVtxMinHadDR_Ele=new TH3D("JetPtVtxMinHadDR_Ele","x:Pt of jet close to electron, y:nVtx, z:dR b/w closest HadJet and electron",7,ptLow2,6,nVtxLow,sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  h3_ElePtVtxMinHadDR=new TH3D("ElePtVtxMinHadDR","x:Electron pT, y:Vtx, z:MinDR with HadJet",7,ptLow2,6,nVtxLow,sizeof(minDRLow)/sizeof(double)-1,minDRLow);
