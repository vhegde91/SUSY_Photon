...
class FakeRateEst : public NtupleVariables{
 ...
 public:
  ...
  TLorentzVector getPxlSeedPhoton();
  int getBinNoV4(int);
  int getBinNoV7(int);
  ...
  TH1D *h_QMult2_Ele,*h_QMult2_Pho;
  TH1D *h_METvBin_Pho_0b,*h_METvBin_Ele_0b;
  TH1D *h_METvBin_Pho_min1b,*h_METvBin_Ele_min1b;
  ...
  TH3D *h3_JetPtJetEtaMinDR_Pho,*h3_JetPtJetEtaMinDR_Ele;
  ...
  double etaLow[6]={0, 0.5, 1.0, 1.4442, 1.566, 3.0};
  ...
  //  vector<double> ptLow2={0,100,140,190,240,300,500,20000};
  vector<double> ptLow2={0,100,120,140,160,180,200,230,260,300,380,500,20000};
  ...
  //  double QMultLow[6]={0,2,4,7,10,100};//22Nov
  vector<double> QMultLow={0,2,4,7,100};
  ...
  TH1D *h_MatchJetPt1_Pho,*h_MatchJetPt2_Pho,*h_MatchJetPt3_Pho,*h_MatchJetPt4_Pho;
  TH1D *h_MatchJetPt1_Ele,*h_MatchJetPt2_Ele,*h_MatchJetPt3_Ele,*h_MatchJetPt4_Ele;
  TH1D *h_PtRatio1_Pho,*h_PtRatio2_Pho,*h_PtRatio3_Pho,*h_PtRatio4_Pho;
  TH1D *h_PtRatio1_Ele,*h_PtRatio2_Ele,*h_PtRatio3_Ele,*h_PtRatio4_Ele;
  TH1D *h_MatchJetEta1_Pho,*h_MatchJetEta2_Pho,*h_MatchJetEta3_Pho,*h_MatchJetEta4_Pho;
  TH1D *h_MatchJetEta1_Ele,*h_MatchJetEta2_Ele,*h_MatchJetEta3_Ele,*h_MatchJetEta4_Ele;
...
void FakeRateEst::BookHistogram(const char *outFileName) {
  ...
  h_METvBin_Pho_0b=new TH1D("METvarBin_Pho_0b","MET with variable bin size for photon like and 0 b-tag events",METBinLowEdgeV4_njLow.size()-1,&(METBinLowEdgeV4_njLow[0]));
  h_METvBin_Pho_min1b=new TH1D("METvarBin_Pho_min1b","MET with variable bin size for photon like and >=1 b-tag events ",METBinLowEdgeV4.size()-1,&(METBinLowEdgeV4[0]));
  ...
  h_QMult2_Pho=new TH1D("QMult2_Pho","Qmult in jet matched to photon",16,0,16);
  ...
  h2_PhotonPtEtavBin=new TH2D("PhotonPtEtavBin","x:Photon |Eta| vs Photon Pt",5,etaLow,ptLow2.size()-1,&(ptLow2[0]));
  h2_JetPtNearPhoEtavBin=new TH2D("JetPtNearPhoEtavBin","x:Jet |Eta| vs jet Pt nearest to photon",5,etaLow,ptLow2.size()-1,&(ptLow2[0]));

  h2_JetPtNearPhoMinDRHadJ=new TH2D("JetPtNearPhoMinDRHadJ","x:minDR b/w a HadJet and photon vs JetPt",sizeof(minDRLow)/sizeof(double)-1,minDRLow,ptLow2.size()-1,&(ptLow2[0]));

  h2_PhoPtMinDRHadJ=new TH2D("PhoPtMinDRHadJ","x:minDR b/w a HadJet and photon vs PhoPt",sizeof(minDRLow)/sizeof(double)-1,minDRLow,ptLow2.size()-1,&(ptLow2[0]));
  h2_PtPhoQHadFracJet=new TH2D("PtPhoQHadFracJet","x:Photon Pt vs charged hadron frac of the matching jet",ptLow2.size()-1,&(ptLow2[0]),sizeof(QHadFracLow)/sizeof(double)-1,QHadFracLow);
  h2_PhoPtQMultJet=new TH2D("PhoPtQMultJet","x: Photon Pt vs charged multiplicity in the matching jet",ptLow2.size()-1,&(ptLow2[0]),QMultLow.size()-1,&(QMultLow[0]));
  ...
  h3_PhotonPtEtaNJ=new TH3D("PhotonPtEtaNJ","x:Photon |Eta|, y:nHadJets, z: photon Pt",5,etaLow,8,nJEtaYLow,ptLow2.size()-1,&(ptLow2[0]));
  h3_PhoPtEtaVtx=new TH3D("PhoPtEtaVtx","x:Photon |Eta|, y:nVtx, z: Photon Pt",5,etaLow,nVtxLow.size()-1,&(nVtxLow[0]),ptLow2.size()-1,&(ptLow2[0]));
  h3_JetPtPhoEtaMinHadDR=new TH3D("JetPtPhoEtaMinHadDR","x:Photon |Eta|, y:matching JetPt, z:MinHadDR",5,etaLow,ptLow2.size()-1,&(ptLow2[0]),sizeof(minDRLow)/sizeof(double)-1,minDRLow);

  h3_JetPtJetEtaMinDR_Pho=new TH3D("JetPtJetEtaMinDR_Pho","x:Pt of jet close to #gamma, y:|#eta| of that jet, z:#DeltaR(#gamma,jet)",9,ptLow,5,etaLow,sizeof(minDRLow)/sizeof(double)-1,minDRLow);

  h3_JetPtVtxMinHadDR_Pho=new TH3D("JetPtVtxMinHadDR_Pho","x:Pt of jet close to photon, y:nVtx, z:dR b/w closest HadJet and photon",ptLow2.size()-1,&(ptLow2[0]),nVtxLow.size()-1,&(nVtxLow[0]),sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  h3_PhoPtVtxMinHadDR=new TH3D("PhoPtVtxMinHadDR","x:Photon pT, y:Vtx, z:MinDR with HadJet",ptLow2.size()-1,&(ptLow2[0]),nVtxLow.size()-1,&(nVtxLow[0]),sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  h3_PhoPtEtaMinDRHadJ=new TH3D("PhoPtEtaMinDRHadJ","x:Photon pT, y:photon |eta|, z:MinDR with HadJet",ptLow2.size()-1,&(ptLow2[0]),5,etaLow,sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  ...
  h_METvBin_Ele_0b=new TH1D("METvarBin_Ele_0b","MET with variable bin size for electron and 0 b-tag events",METBinLowEdgeV4_njLow.size()-1,&(METBinLowEdgeV4_njLow[0]));
  h_METvBin_Ele_min1b=new TH1D("METvarBin_Ele_min1b","MET with variable bin size for electron and >=1 b-tag events ",METBinLowEdgeV4.size()-1,&(METBinLowEdgeV4[0]));
  ...
  h2_JetPtNearEleMinDRHadJ=new TH2D("JetPtNearEleMinDRHadJ","x:minDR b/w a HadJet and electron vs JetPt",sizeof(minDRLow)/sizeof(double)-1,minDRLow,ptLow2.size()-1,&(ptLow2[0]));
  ...
  h2_ElePtMinDRHadJ=new TH2D("ElePtMinDRHadJ","x:minDR b/w a HadJet and electron vs ElePt",sizeof(minDRLow)/sizeof(double)-1,minDRLow,ptLow2.size()-1,&(ptLow2[0]));
  h2_PtEleQHadFracJet=new TH2D("PtEleQHadFracJet","x:Electron Pt vs charged hadron frac of the matching jet",ptLow2.size()-1,&(ptLow2[0]),sizeof(QHadFracLow)/sizeof(double)-1,QHadFracLow);
  h2_ElePtQMultJet=new TH2D("ElePtQMultJet","x: Electron Pt vs charged multiplicity in the matching jet",ptLow2.size()-1,&(ptLow2[0]),QMultLow.size()-1,&(QMultLow[0]));
  ...
  h2_ElePtEtavBin=new TH2D("ElePtEtavBin","x:Electron |Eta| vs Electron Pt",5,etaLow,ptLow2.size()-1,&(ptLow2[0]));
  h2_JetPtNearEleEtavBin=new TH2D("JetPtNearEleEtavBin","x:Jet |Eta| vs jet Pt nearest to electron",5,etaLow,ptLow2.size()-1,&(ptLow2[0]));
  ...
  h3_ElePtEtaNJ=new TH3D("ElePtEtaNJ","x:Electron |Eta|, y:nHadJets, z: Electron Pt",5,etaLow,8,nJEtaYLow,ptLow2.size()-1,&(ptLow2[0]));
  h3_ElePtEtaVtx=new TH3D("ElePtEtaVtx","x:Electron |Eta|, y:nVtx, z: Electron Pt",5,etaLow,nVtxLow.size()-1,&(nVtxLow[0]),ptLow2.size()-1,&(ptLow2[0]));
  h3_JetPtEleEtaMinHadDR=new TH3D("JetPtEleEtaMinHadDR","x:Electron |Eta|, y:matching JetPt, z:MinHadDR",5,etaLow,ptLow2.size()-1,&(ptLow2[0]),sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  h3_JetPtJetEtaMinDR_Ele=new TH3D("JetPtJetEtaMinDR_Ele","x:Pt of jet close to e, y:|#eta| of that jet, z:#DeltaR(e,jet)",9,ptLow,5,etaLow,sizeof(minDRLow)/sizeof(double)-1,minDRLow);

  h3_JetPtVtxMinHadDR_Ele=new TH3D("JetPtVtxMinHadDR_Ele","x:Pt of jet close to electron, y:nVtx, z:dR b/w closest HadJet and electron",ptLow2.size()-1,&(ptLow2[0]),nVtxLow.size()-1,&(nVtxLow[0]),sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  h3_ElePtVtxMinHadDR=new TH3D("ElePtVtxMinHadDR","x:Electron pT, y:Vtx, z:MinDR with HadJet",ptLow2.size()-1,&(ptLow2[0]),nVtxLow.size()-1,&(nVtxLow[0]),sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  h3_ElePtEtaMinDRHadJ=new TH3D("ElePtEtaMinDRHadJ","x:Electron pT, y:electron |eta|, z:MinDR with HadJet",ptLow2.size()-1,&(ptLow2[0]),5,etaLow,sizeof(minDRLow)/sizeof(double)-1,minDRLow);
  ...
  h_MatchJetPt1_Pho=new TH1D("MatchJetPt1_Pho","Photon MatchJetPt for minDR<0.05",150,0,1500);
  h_MatchJetPt2_Pho=new TH1D("MatchJetPt2_Pho","Photon MatchJetPt for 0.05<minDR<0.10",150,0,1500);
  h_MatchJetPt3_Pho=new TH1D("MatchJetPt3_Pho","Photon MatchJetPt for 0.10<minDR<0.20",150,0,1500);
  h_MatchJetPt4_Pho=new TH1D("MatchJetPt4_Pho","Photon MatchJetPt for 0.20<minDR<0.40",150,0,1500);
  h_MatchJetEta1_Pho=new TH1D("MatchJetEta1_Pho","Photon MatchJetEta for minDR<0.05",60,0,6);
  h_MatchJetEta2_Pho=new TH1D("MatchJetEta2_Pho","Photon MatchJetEta for 0.05<minDR<0.10",60,0,6);
  h_MatchJetEta3_Pho=new TH1D("MatchJetEta3_Pho","Photon MatchJetEta for 0.10<minDR<0.20",60,0,6);
  h_MatchJetEta4_Pho=new TH1D("MatchJetEta4_Pho","Photon MatchJetEta for 0.20<minDR<0.40",60,0,6);
  h_PtRatio1_Pho=new TH1D("PtRatio1_Pho","PhotonJet/Photon PtRatio for minDR<0.05",100,0,5);
  h_PtRatio2_Pho=new TH1D("PtRatio2_Pho","PhotonJet/Photon PtRatio for 0.05<minDR<0.10",100,0,5);
  h_PtRatio3_Pho=new TH1D("PtRatio3_Pho","PhotonJet/Photon PtRatio for 0.10<minDR<0.20",100,0,5);
  h_PtRatio4_Pho=new TH1D("PtRatio4_Pho","PhotonJet/Photon PtRatio for 0.20<minDR<0.40",100,0,5);


  h_MatchJetPt1_Ele=new TH1D("MatchJetPt1_Ele","Electron MatchJetPt for minDR<0.05",150,0,1500);
  h_MatchJetPt2_Ele=new TH1D("MatchJetPt2_Ele","Electron MatchJetPt for 0.05<minDR<0.10",150,0,1500);
  h_MatchJetPt3_Ele=new TH1D("MatchJetPt3_Ele","Electron MatchJetPt for 0.10<minDR<0.20",150,0,1500);
  h_MatchJetPt4_Ele=new TH1D("MatchJetPt4_Ele","Electron MatchJetPt for 0.20<minDR<0.40",150,0,1500);
  h_MatchJetEta1_Ele=new TH1D("MatchJetEta1_Ele","Electron MatchJetEta for minDR<0.05",60,0,6);
  h_MatchJetEta2_Ele=new TH1D("MatchJetEta2_Ele","Electron MatchJetEta for 0.05<minDR<0.10",60,0,6);
  h_MatchJetEta3_Ele=new TH1D("MatchJetEta3_Ele","Electron MatchJetEta for 0.10<minDR<0.20",60,0,6);
  h_MatchJetEta4_Ele=new TH1D("MatchJetEta4_Ele","Electron MatchJetEta for 0.20<minDR<0.40",60,0,6);
  h_PtRatio1_Ele=new TH1D("PtRatio1_Ele","ElectronJet/Electron PtRatio for minDR<0.05",100,0,5);
  h_PtRatio2_Ele=new TH1D("PtRatio2_Ele","ElectronJet/Electron PtRatio for 0.05<minDR<0.10",100,0,5);
  h_PtRatio3_Ele=new TH1D("PtRatio3_Ele","ElectronJet/Electron PtRatio for 0.10<minDR<0.20",100,0,5);
  h_PtRatio4_Ele=new TH1D("PtRatio4_Ele","ElectronJet/Electron PtRatio for 0.20<minDR<0.40",100,0,5);
  ...
  h_SBins_v7_Ele = new TH1D("AllSBins_v7_Ele","search bins: [ NJ:2-4, NJ:5or6, NJ>=7] x [0b, >=1b] for electron events",31,0.5,31.5);
  h_SBins_v7_Pho = new TH1D("AllSBins_v7_Pho","search bins: [ NJ:2-4, NJ:5or6, NJ>=7] x [0b, >=1b] for photon like events",31,0.5,31.5);
