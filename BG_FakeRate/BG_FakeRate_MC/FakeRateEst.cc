...
void FakeRateEst::EventLoop(const char *data,const char *inputFileList) {
  ...
  //  TH1* puhist = (TH1*)pufile->Get("pu_weights_central");
  // int promptFiles=1;
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	for(int i=0;i<GenJets->size();i++){
	  ...
	  if(BTags==0) h_METvBin_Ele_0b->Fill(MET,wt);
	  else h_METvBin_Ele_min1b->Fill(MET,wt);
	  ...
	  h3_JetPtJetEtaMinDR_Ele->Fill( (*Jets)[minDRindx].Pt(),abs((*Jets)[minDRindx].Eta()),minDR,wt);
	  ...
	  if(minDR<0.05) h_MatchJetPt1_Ele->Fill((*Jets)[minDRindx].Pt(),wt);
	  else if(minDR<0.1) h_MatchJetPt2_Ele->Fill((*Jets)[minDRindx].Pt(),wt);
	  else if(minDR<0.2) h_MatchJetPt3_Ele->Fill((*Jets)[minDRindx].Pt(),wt);
	  else if(minDR<0.4) h_MatchJetPt4_Ele->Fill((*Jets)[minDRindx].Pt(),wt);
	  if(minDR<0.05) h_MatchJetEta1_Ele->Fill(abs((*Jets)[minDRindx].Eta()),wt);
	  else if(minDR<0.1) h_MatchJetEta2_Ele->Fill(abs((*Jets)[minDRindx].Eta()),wt);
	  else if(minDR<0.2) h_MatchJetEta3_Ele->Fill(abs((*Jets)[minDRindx].Eta()),wt);
	  else if(minDR<0.4) h_MatchJetEta4_Ele->Fill(abs((*Jets)[minDRindx].Eta()),wt);
	  if(minDR<0.05) h_PtRatio1_Ele->Fill(((*Jets)[emObjMatchingJetIndx].Pt())/(bestEMObj.Pt()),wt);
	  else if(minDR<0.1) h_PtRatio2_Ele->Fill(((*Jets)[emObjMatchingJetIndx].Pt())/(bestEMObj.Pt()),wt);
	  else if(minDR<0.2) h_PtRatio3_Ele->Fill(((*Jets)[emObjMatchingJetIndx].Pt())/(bestEMObj.Pt()),wt);
	  else if(minDR<0.4) h_PtRatio4_Ele->Fill(((*Jets)[emObjMatchingJetIndx].Pt())/(bestEMObj.Pt()),wt);
	...
	//   }
	  ...
	  if(BTags==0) h_METvBin_Pho_0b->Fill(MET,wt);
	  else h_METvBin_Pho_min1b->Fill(MET,wt);
	  ...
	  h3_JetPtJetEtaMinDR_Pho->Fill( (*Jets)[minDRindx].Pt(),abs((*Jets)[minDRindx].Eta()),minDR,wt);
	  ...
	  if(minDR<0.05) h_MatchJetPt1_Pho->Fill((*Jets)[minDRindx].Pt(),wt);
	  else if(minDR<0.1) h_MatchJetPt2_Pho->Fill((*Jets)[minDRindx].Pt(),wt);
	  else if(minDR<0.2) h_MatchJetPt3_Pho->Fill((*Jets)[minDRindx].Pt(),wt);
	  else if(minDR<0.4) h_MatchJetPt4_Pho->Fill((*Jets)[minDRindx].Pt(),wt);
	  if(minDR<0.05) h_MatchJetEta1_Pho->Fill(abs((*Jets)[minDRindx].Eta()),wt);
	  else if(minDR<0.1) h_MatchJetEta2_Pho->Fill(abs((*Jets)[minDRindx].Eta()),wt);
	  else if(minDR<0.2) h_MatchJetEta3_Pho->Fill(abs((*Jets)[minDRindx].Eta()),wt);
	  else if(minDR<0.4) h_MatchJetEta4_Pho->Fill(abs((*Jets)[minDRindx].Eta()),wt);
	  if(minDR<0.05) h_PtRatio1_Pho->Fill(((*Jets)[emObjMatchingJetIndx].Pt())/(bestEMObj.Pt()),wt);
	  else if(minDR<0.1) h_PtRatio2_Pho->Fill(((*Jets)[emObjMatchingJetIndx].Pt())/(bestEMObj.Pt()),wt);
	  else if(minDR<0.2) h_PtRatio3_Pho->Fill(((*Jets)[emObjMatchingJetIndx].Pt())/(bestEMObj.Pt()),wt);
	  else if(minDR<0.4) h_PtRatio4_Pho->Fill(((*Jets)[emObjMatchingJetIndx].Pt())/(bestEMObj.Pt()),wt);
