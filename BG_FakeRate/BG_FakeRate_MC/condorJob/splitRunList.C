...
void splitRunList(string infile,int nfPerJob){
  ...
  string datasetAna = "CS_FR";
  string rootFilesToTransfer = "PileupHistograms_0121_69p2mb_pm4p6.root,FR_Hist_CS_TTW_FR_ISRWt_v2.root,kfactors.root,FR_Hist_CS_TTW_FR_ISRWt_LowDphi_v2.root";
                               //give the name of the files seperated by comma(,). Ex:("a.root,b.root")
  //---------------------------------------------------
  if(tstr1.Contains("TTJets")) datasetAna = "TTJets";
