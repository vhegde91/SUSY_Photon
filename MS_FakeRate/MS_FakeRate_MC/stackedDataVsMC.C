...
int col[10]={kBlack,kBlue,kMagenta+2,kOrange,kYellow,kGreen,kTeal+9,kPink+1,kCyan,kRed};  //Specify Colors
TString name;
bool saveCanvas=0;
...
void stackedDataVsMC(TString iFname){
  ...
  //  f[1] = new TFile("FR_Hist_MS_FR_DYJetsToLL_ST200_QMultSFPho_v2.root");
  //  f[1] = new TFile("FR_Hist_MS_FR_DYJetsToLL_ST200_v2.root");
  f[1] = new TFile("FR_Hist_MS_FR_DYJetsToLL_ST200_BGSub_QMultSFPho_v2.root");
  //  f[1] = new TFile("MS_FR_DYJetsToLL_ST200_v2.root");
  // f[4] = new TFile("MS_TTJets_FR_ST200NoZWindow.root");
  // f[3] = new TFile("MS_WG_FR_ST200NoZWindow.root");
  // f[2] = new TFile("MS_TTG_FR_ST200NoZWindow.root");
  // f[1] = new TFile("MS_FR_DYJetsToLL_ST200Trg_v2.root");

  vector<string> name1;
  vector<int> rebin;
  // name1.push_back("ST_Ele");  rebin.push_back(10);
  // name1.push_back("MET_Ele");    rebin.push_back(5);
  // name1.push_back("nBTags_Ele");   rebin.push_back(1);
  // name1.push_back("nHadJets_Ele");  rebin.push_back(1);
  // name1.push_back("ZMass_Ele");   rebin.push_back(5);
  // name1.push_back("F_ElePt_Ele"); rebin.push_back(2);
  // name1.push_back("F_EleEta_Ele"); rebin.push_back(5);
  //name1.push_back("F_ElePhi_Ele"); rebin.push_back(2);
  //name1.push_back("R_ElePt_Ele"); rebin.push_back(2);
  // name1.push_back("R_EleEta_Ele"); rebin.push_back(5);
  //name1.push_back("nVtx_Ele"); rebin.push_back(5);
  // name1.push_back("isoEleTracks_Ele"); rebin.push_back(1);
  // name1.push_back("dPhi1_Ele"); rebin.push_back(1);
  // name1.push_back("dPhi2_Ele"); rebin.push_back(1);
  // name1.push_back("dphi_elefMET_Ele"); rebin.push_back(1);
  // name1.push_back("dphi_elerMET_Ele"); rebin.push_back(1);
  // name1.push_back("dPhi_elef_eler_Ele"); rebin.push_back(1);
  // name1.push_back("mTProbeMET_Ele"); rebin.push_back(5);
  //  name1.push_back("QMultJetElef_Ele"); rebin.push_back(2);

  // name1.push_back("ST_Pho");  rebin.push_back(10);
  // name1.push_back("MET_Pho");    rebin.push_back(5);
  // name1.push_back("nBTags_Pho");   rebin.push_back(1);
  // name1.push_back("nHadJets_Pho");  rebin.push_back(1);
  // name1.push_back("ZMass_Pho");   rebin.push_back(5);
  // name1.push_back("F_ElePt_Pho"); rebin.push_back(5);
  // name1.push_back("F_ElePtvBin_Pho"); rebin.push_back(1);
  // name1.push_back("F_Eleeta_Pho"); rebin.push_back(5);
  // name1.push_back("F_ElePhi_Pho"); rebin.push_back(2);
  //  name1.push_back("R_ElePt_Pho"); rebin.push_back(5);
  //name1.push_back("R_EleEta_Pho"); rebin.push_back(5);
  // name1.push_back("nVtx_Pho"); rebin.push_back(5);

  //  name1.push_back("isoEleTracks_Pho"); rebin.push_back(1);
  // name1.push_back("dPhi1_Pho"); rebin.push_back(1);
  // name1.push_back("dPhi2_Pho"); rebin.push_back(1);
  // name1.push_back("dphi_elefMET_Pho"); rebin.push_back(1);
  //  name1.push_back("dphi_elerMET_Pho"); rebin.push_back(1);
  // name1.push_back("dPhi_elef_eler_Pho"); rebin.push_back(1);
  // name1.push_back("mTProbeMET_Pho"); rebin.push_back(5);
  //  name1.push_back("QMultJetElef_Pho"); rebin.push_back(2);
  //name1.push_back("Pho2Pt"); rebin.push_back(1);
  
  name1.push_back("FakeRate_ST_Pho");  rebin.push_back(1);
  // name1.push_back("FakeRate_MET_Pho");    rebin.push_back(1);
  // name1.push_back("FakeRate_nBTags_Pho");   rebin.push_back(1);
  name1.push_back("FakeRate_nHadJets_Pho");  rebin.push_back(1);
  name1.push_back("FakeRate_F_ElePt_Pho"); rebin.push_back(1);
  name1.push_back("FakeRate_F_ElePtvBin_Pho"); rebin.push_back(1);
  // name1.push_back("FakeRate_F_Eleeta_Pho"); rebin.push_back(1);
  //  name1.push_back("FakeRate_F_ElePhi_Pho"); rebin.push_back(1);
  // name1.push_back("FakeRate_R_ElePt_Pho"); rebin.push_back(1);
  //name1.push_back("FakeRate_nVtx_Pho"); rebin.push_back(1);
  name1.push_back("FakeRate_QMultJetElef_Pho"); rebin.push_back(1);
  // name1.push_back("FakeRate_ZMass_Pho"); rebin.push_back(4);
  ...
  for(int i=0;i<name1.size();i++){
    ...
    if(name1[i]=="nHadJets_Pho") data_fakeEvts=h_histG->Integral();
    ...
    for(int p=1;p<nfiles;p++){  
      ...
      if(name1[i]=="nHadJets_Pho") mc_fakeEvts=h_histE->Integral();
	...
	h_sum[i] = (TH1D*)h_histE->Clone(name);
      ...
      legend[i]->AddEntry(h_histE,getLegName(f[p]->GetName()),"lep");
    }
    c_cA[i]->cd();    p_top[i]->cd();
    //    hs_hist[i]->Draw("BAR");
    hs_hist[i]->Draw();
    h_histG->Draw("same");
    hs_hist[i]->SetTitle(";;Fakerate");
