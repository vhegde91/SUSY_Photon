...
void fitMyZ(){
  ...
  TFile *f1 = new TFile("MS_FR_LL_2016_NoZWindow.root");
  TH1D *h_zmass=(TH1D*)f1->FindObjectAny("ZMass_ge");
  ...
  TF1 *ft1=new TF1("ft1",fitFunction,55,500,6);
  ft1->SetNpx(5000);
  ...
  // improve the picture:
  TF1 *backFcn = new TF1("backFcn",background,55,500,3);
  backFcn->SetLineColor(kGreen);
  TF1 *signalFcn = new TF1("signalFcn",mybw,55,500,3);
