...
// Wed Jun 28 11:25:09 2017 by ROOT version 6.04/02
// from TTree PreSelection/PreSelection
// found on file: SingEle16ReMiniAOD_RA2AnalysisTree.root
//////////////////////////////////////////////////////////
...
#ifdef ten_cxx
ten::ten(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("SingEle16ReMiniAOD_RA2AnalysisTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("SingEle16ReMiniAOD_RA2AnalysisTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("SingEle16ReMiniAOD_RA2AnalysisTree.root:/TreeMaker2");
...
Int_t ten::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ten::LoadTree(Long64_t entry)
{
