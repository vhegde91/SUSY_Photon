...
void LostMuon::BookHistogram(const char *outFileName) {
  ...
  h_MET_R_v2_Mu0[4] =new TH1D("MET_R5_v2_Mu0","MET for b>=2 for 0 Mu events",METBinLowEdge.size()-1,&(METBinLowEdge[0]));  
  ...
  h_MET_R_v2_Mu1[4] =new TH1D("MET_R5_v2_Mu1","MET for b>=2 for 1 Mu events",METBinLowEdge.size()-1,&(METBinLowEdge[0]));  
